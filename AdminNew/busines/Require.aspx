    ...
    <div id="xiadan">
	    ...
	    <div class="jd_tips" style="margin-bottom:30px;">
            ...
            <%if (activemethod == "1"){%>
                ...
                <div class="cour_div">
                    <p class="cour_div_p38"><span class="cour_p_span">5、</span>请认准商家旺旺：<font color="#FC3C75"><%=SellerName.Length>0?SellerName.Substring(0,1) + "******" + SellerName.Substring(SellerName.Length - 1):SellerName %></font></p>
                </div>
                <div class="cour_div">
