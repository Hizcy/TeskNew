...
public partial class busines_addGoodsb : BasePage//System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            Jnwf.Utils.Log.Logger.Log4Net.Error("abdan:ASPSESSID:" + Session.SessionID);
            Jnwf.Utils.Log.Logger.Log4Net.Error("abdan:AUTHID:" + Request.Cookies[FormsAuthentication.FormsCookieName].Value);
            //绑定
