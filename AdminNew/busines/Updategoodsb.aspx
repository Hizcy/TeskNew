<%@ Page Title="拍A送B-91折品购" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Updategoodsb.aspx.cs" Inherits="busines_Updategoodsb" %>
            ...
            <div class="mod_taber mod_taber0">
                <div class="mod_taber_hd">
                    <ul class="mod_hlist mod_taber_menu" id="tags_menu">
                        <li><a href="../busines/addGoods.aspx"  class="on"><span>发布试用(拍A送B)</span></a></li>
                    </ul>
                </div>
