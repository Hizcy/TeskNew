...
public partial class busines_TaskYong :BasePage //System.Web.UI.Page
{
    ...
    public string showStatus(int status, int id, string img)
    {
        ...
        {
            return "<a href='#' onclick=\"fdimg(" + id + ",'" + img + "'," + status + ")\"><img src=\"" + imgUrlReplace(img,"s") + "\" style=\"width:50px;height:50px;\" onerror=\"this.src='../images/touxt.jpg';\" /></a>";
        }
        else
        {
            return "--";
