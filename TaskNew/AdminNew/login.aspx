                    ...
                    <div class="rule-list">
                            ...
                            <div class="reg-switch-box J_switch_box">
                                <div class="J_login Fix">
                                    <ul class="login-new-ul">
                                        ...
                                        <li class="J_action">
                                            <asp:Button style="background-color:#F07;font-weight: bolder;padding:10px;border-radius:5px;margin-left:80px;color: #fff;font-size: 18px;width:208px;border: 0;" ID="Button1" runat="server" Text="登录" OnClick="btn_dl_Click" OnClientClick="denglu()" />
                                        </li>
                        ...
                        <div class="aside-right-new">
                            ...
                            <div class="J_login_3rd">
                                <span class="login"><a href="sjbd.aspx" target="_blank"><img src="images/shangjiaxiaotu.png" width="250" height="250" /></a></span>
                            </div>
                        </div>
                    </div>
                </div>
