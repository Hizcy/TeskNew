...
using System.Data;
public partial class busines_TaskListAB : BasePage//System.Web.UI.Page
{
    ...
    private void BindData()
    {
        if (identity != null)
        {
            ...
            DataSet ds = Task.BLL.tb_TaskBLL.GetInstance().GetTaskInfor(pager1.PageSize, CurrentPage, " 1=1 and activetype=2" + where, out allCount);
    ...
    public string showData(int audit, int id, decimal money, decimal GuaranteePrice, string TaskCode, int ActiveType)
    {
        ...
        {
            return "<p><a href=\"TradeABlist.aspx?id=" + id + "\" style=\"color:#fe4800;\">资格审核</a></p><p><a href=\"TaskAB.aspx?type=" + id + "\" style=\"color:#3DC054;\">管理订单</a></p><p><a href=\"updateGoodsb.aspx?id=" + id + "\" style=\"color:#808080;\">修改商品</a></p>";
        }
