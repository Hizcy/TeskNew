<%@ Page Title="佣金订单管理-91折品购" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="TaskYong.aspx.cs" Inherits="busines_TaskYong" %>
            ...
            <div class="mod_taber mod_taber0">
                <div class="mod_taber_hd">
                    <ul class="mod_hlist mod_taber_menu" id="tags_menu">
                        <li><a href="TaskYong.aspx?type=<%=id %>" id="qb"><span>全部</span></a></li>
                                            ...
                                            <ItemTemplate>
                                                <tr onmouseover="$(this).addClass('hover');" onmouseout="$(this).removeClass('hover');" class="">
                                                    ...
                                                    <%#Eval("Buyer") %></font>
                                                        ...
                                                        <p style="margin-top: 7px;"><font color="#09f">QQ:<a href="http://wpa.qq.com/msgrd?v=3&amp;uin=<%#Eval("QQ") %>&amp;site=qq&amp;menu=yes" target="_blank" style="color:#09f; text-decoration:none;
