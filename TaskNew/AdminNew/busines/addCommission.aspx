<%@ Page Title="佣金任务-91折品购" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="addCommission.aspx.cs" Inherits="busines_addCommission" %>
            ...
            <div class="mod_taber mod_taber0">
                <div class="mod_taber_hd">
                    <ul class="mod_hlist mod_taber_menu" id="tags_menu">
                        <li><a href="../busines/addCommission.aspx" class="on"><span>发布佣金任务</span></a><i class="hot_ico"></i></li>
                    </ul>
                </div>
                        ...
                        <div class="mod_taber_page_bd" id="record_table">
                            <div class="mod_taber_page_sec">
                                <div class="ipt_box">
                                    <ul class="ipt_ul">
                                        <li>
                                            <span class="form_name">佣金任务就是会员购买你这件商品后你给予奖励的现金。</span>
                                        </li>
                                        <li>
                                        ...
                                        <li >
                                         ...
                                         <li>
                                            ...
                                            <input type="text" id="lower_price"  class="ipt_inform_120" onfocus="if(this.value=='店铺拍下价格') {this.value='';}this.style.color='#333';" onblur="if(this.value=='') {this.value='店铺拍下价格';this.style.color='#999';}else{jisuan('');}" value="店铺拍下价格"  />
                                        </li>
                                        <li>
                                       ...
                                       <%--  <li>
                                        ...
                                        <li>
                                            ...
                                            <div class="hb_box">
                                                ...
                                                <input id="txtCommissionPrice" class="text_box" type="text" disabled="disabled" value="2.0" />
                                       ...
                                       <li>
                                        ...
                                        <li>
                                           ...
                                           <div id="tupianpc" style="padding: 20px;border:1px solid #CCC;margin-left:55px;margin-bottom:10px;width:590px;text-align:center;border-bottom:none;display:block;height:220px;" >
                                               ...
                                               <a href="<%=path %>images/dn-1.jpg" target="_blank" ><img src="../images/dn.png" style="float:left;margin-left:6px;"/></a><a href="<%=path %>images/sj-1.jpg" target="_blank"><img src="../images/sj.png"  style="float:left;margin-left:6px;"/></a>
                                               <span style="margin-top: 110px;float: left;margin-left: -186px;background-color:#3DC054;color:#fff;padding:3px"><a href="<%=path %>images/dn-1.jpg" target="_blank" style="color:#fff">点击查看</a></span>
                                               <span style="margin-top: 110px;float: left;margin-left: -76px;background-color:#3DC054;color:#fff;padding:3px"><a href="<%=path %>images/sj-1.jpg" target="_blank" style="color:#fff">点击查看</a></span>
                                            ...
                                            <div id="tupianshouji" style="padding: 20px;border:1px solid #CCC;margin-left:55px;margin-bottom:10px;width:590px;text-align:center;height:220px;border-bottom:none;display:none" >
                                              <%-- <div id="goodshouji">&nbsp;</div>--%>
                                               <div id="img4"><img id="imgdel4" src="../images/xiadanyindaotu.png"  width="200" height="200" style="float:left;border:1px solid #CCC"  /></div>
                                                <span style="font-size:12px;color:#666666;padding-left:6px">必须上传下单引导图<font color="#FF6600" size="2">(下单页面显示搜索图,标记价格/旺旺/商品名称等）</font>)</span> <br />
                                               <span style="font-size:12px;color:#666666;margin-left:6px;float:left">单张图片大小不能超过500KB</span><br />
                                               <a href="<%=path %>images/dn-1.jpg"><img src="../images/dn.png" style="float:left;margin-left:6px;"/></a><a href="<%=path %>images/sj-1.jpg"><img src="../images/sj.png" style="float:left;margin-left:6px;"/></a>
                                            ...
                                            <div style="padding: 20px;border:1px solid #CCC;margin-left:55px;margin-bottom:10px;width:590px;border-top:none;margin-top: -50px;" >
                                                 <div style="padding:0 30px">
                                                   <input type="button" value="上传图片" id="browse2" class="pingtainew"/>
                                                 </div>
										...
										<li style=" margin-bottom:2px;">
											<div class="title_lbl">商家要求:</div>
                                                ...
                                                <span class="form_hint" id="sell_yaoqiu_mode" onclick="int_mode(1);" style="background-color:#d45252;margin-left:320px;cursor: pointer;">商家要求模板</span>
										</li>
                                        <li>
                                            <script id="edcontent" name="edcontent" type="text/plain" style="width:624px;height:400px;margin-left:60px;height:240px;">
                                            </script>
                                          <%--   <textarea id="lytx" style="width:650px; height:170px;  border: 1px dashed #0f91b8; color:#666666;margin-left:60px;font-size:14px">
I、打开淘宝网站
II、产品大致在第--页
III、认准对比图上的主图，下单前假聊产品相关的5-10句
V、禁止搜店铺和秒拍。请核对好宝贝和价格，确认好再下单
IV、快递默认：--
IIV、签收后，请及时到店确认收货并写大约20字与之相关的好评语。
                                                </textarea>  --%> 
										</li>
                                        <li class="form_bonn">
