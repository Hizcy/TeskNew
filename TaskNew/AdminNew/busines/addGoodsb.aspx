<%@ Page Title="拍A送B-91折品购" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="addGoodsb.aspx.cs" Inherits="busines_addGoodsb" %>
            ...
            <div class="mod_taber mod_taber0">
                <div class="mod_taber_hd">
                    <ul class="mod_hlist mod_taber_menu" id="tags_menu">
                        <li><a href="../busines/addGoodsb.aspx" class="on"><span>发布试用(拍A送B)</span></a></li>
                    </ul>
                </div>
                        ...
                        <div class="mod_taber_page_bd" id="record_table">
                            <div class="mod_taber_page_sec">
                                <div class="ipt_box">
                                    <ul class="ipt_ul">
                                        <li>
                                            <span class="form_name">A为你店铺里实际卖的产品，B为你要免费送的产品。拍A送B活动需要加送佣金至少（1元）</span>
                                        </li>
                                        <li>
                                            <div class="title_lbl">A来　源:</div>
                                        ...
                                        <li >
                                         ...
                                         <li>
                                            <div class="title_lbl">B产品名:</div>
                                            <input type="text" id="sell_cp_title" class="ipt_inform_500"/>
                                        </li>
                                        <li id="sell_shi_url">
                                            <div class="title_lbl">A链　接:</div>
                                        ...
                                        <li>
                                            ...
                                            <div class="hb_box">
                                                ...
                                                <input id="txtCommissionPrice" class="text_box" type="text" disabled="disabled" value="1.0" />
                                        ...
                                        <%--<li>
                                            ...
                                            <div id="lbl_dbnum" style="margin-left:50px;width:60px" class="form_name_ser">等待计算...</div>
                                        </li>--%>
                                        <li>
                                            <div class="title_lbl">担保金:</div>
                                        ...
                                        <li style="height: 300px;">
                                            ...
                                            <div style="padding: 20px;border: 1px solid #CCC;margin:-10px auto 0px 55px;width:590px;height:250px;" >
                                                ...
                                                <%--<input type="button" value="上传截图" style="width:70px;height:30px;background:#0a92bb;color: #FFFFFF;cursor: pointer;font-size: 9pt;margin:160px auto auto -200px;" onclick="upload(1)"/>--%>
                                                 <div style="margin-top:150px;padding: 10px 55px;">
    ...
    <script type="text/javascript">
            ...
            if (taskid > 0) {
                $.ajax({
                    ...
                    success: function (result) {
                        if (result > 0) {
                            alert("修改成功！请去确认担保金！");
                            window.location.href = "TaskListAB.aspx";
                        }
                        else {
                            alert("修改任务失败！");
                        }
        ...
        function jisuan(flag) {
            ...
            if ((reg.test(lower_price) || reg2.test(lower_price)) && !isNaN(lower_allnum)) {
                ...
                $("#lbl_dbnum").html(guaranteePrice + " 元 = (A下单价：" + lower_price + " 元 + B红包：" + commissionPrice + " 元) *" + lower_allnum + " 份");
            }
            else {
        ...
        $(function () {
            //$('#lower_price').trigger('click');
            //$('#lower_allnum').trigger('click');
            ////$("#lower_price").click();
            ////$("#lower_allnum").click();
            //alert(1);
            $("#tianmao").is(":checked")
