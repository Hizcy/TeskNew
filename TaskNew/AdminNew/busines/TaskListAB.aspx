<%@ Page Title="拍A发B任务管理-91折品购" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="TaskListAB.aspx.cs" Inherits="busines_TaskListAB" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
                ...
                <div class="mod_taber mod_taber0">
                    <div class="mod_taber_hd">
                        <ul class="mod_hlist mod_taber_menu" id="tags_menu">
                            <li><a href="TaskShia.aspx" id="qb"><span>全部商品</span></a></li>
                                ...
                                <div class="mod_taber_page_bd" id="jifen_flow">
                                    <table class="i_mod_tableA">
                                            ...
                                            <tr> 
                                                ...
                                                <th scope="col" style="width:120px;">下单价/下单/店铺</th>
                                                <th scope="col" style="width:80px;">担保金/红包</th>
    ...
    <script>
        ...
        //任务充值
        function chongzhi(id, zMoney, guaranteePrice, taskCode, activeType) {

            if (zMoney < guaranteePrice) {
