<%@ Page Title="拍A发B订单管理-91折品购" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="TaskAB.aspx.cs" Inherits="busines_TaskAB" %>
        ...
        <div class="mod_taber mod_taber0">
            <div class="mod_taber_hd">
                <ul class="mod_hlist mod_taber_menu" id="tags_menu">
                    <li><a href="TaskAB.aspx?type=<%=id %>" id="qb"><span>全部</span></a></li>
                    <li><a href="TaskAB.aspx?id=2&type=<%=id %>" id="dt"><span>待填订单</span></a></li>
                    <li><a href="TaskAB.aspx?id=1&type=<%=id %>" id="sh"><span>待审订单</span></a></li>
                    <li><a href="TaskAB.aspx?id=3&type=<%=id %>" id="dc"><span>待传截图</span></a></li> 
                    <li><a href="TaskAB.aspx?id=4&type=<%=id %>" id="yc"><span>已传截图</span></a></li>
                    <li><a href="TaskAB.aspx?id=5&type=<%=id %>" id="wc"><span>已完成</span></a></li>
                </ul>
            </div>
...
display: inline-flex;"><%#Eval("QQ") %></a></font></p></td>
                                                ...
                                                <%#auditStatus(int.Parse(Eval("Audit").ToString()),int.Parse(Eval("id").ToString()),Eval("name").ToString(),int.Parse(Eval("ActiveType").ToString()),int.Parse(Eval("bbyer").ToString()),int.Parse(Eval("buserid").ToString()),int.Parse(Eval("evaluation").ToString()),Eval("TaskCode").ToString()) %>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
    ...
    <script>
        ...
        //弹层打分给试客
        function evaluation(id, buserid, activeType, taskCode) {
            //标识点击第几个星
            var tmpflag = -1;
            layer.confirm('打分：<a class=\"imglist\"><img src="../images/T1j_SkXl0fXXXXXXXX-19-19.png" /><img src="../images/T1j_SkXl0fXXXXXXXX-19-19.png" /><img src="../images/T1j_SkXl0fXXXXXXXX-19-19.png" /><img src="../images/T1j_SkXl0fXXXXXXXX-19-19.png" /><img src="../images/T1j_SkXl0fXXXXXXXX-19-19.png" /></a><br/>'
                        + '<textarea autofocus="autofocus" maxlength="100" placeholder="评价内容不能超过100字！" style="width:275px;height:100px" id=\"txtcontent\" ></textarea><br/>', {
                            ...
                            $.ajax({
                                ...
                                type: "POST",
                                dataType: "JSON",
                                data: { type: "evaluation", score: tmpflag + 1, id: id, buserid: buserid, description: $.trim($("#txtcontent").val()), activeType: activeType, taskCode: taskCode },
                                success: function (result) {
                                    if (result == 1) {
