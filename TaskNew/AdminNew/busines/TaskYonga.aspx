<%@ Page Title="佣金任务管理-91折品购" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="TaskYonga.aspx.cs" Inherits="busines_TaskYonga" %>
                ...
                <div class="mod_taber mod_taber0">
                    <div class="mod_taber_hd">
                        <ul class="mod_hlist mod_taber_menu" id="tags_menu">
                             <li><a href="taskyonga.aspx" id="qb"><span>全部商品</span></a></li>
