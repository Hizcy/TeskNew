...
public partial class user_TaskShi :BasePage //System.Web.UI.Page
{
    ...
    private void BindData()
    {
        if (identity != null)
        {
            ...
            DataSet ds = Task.BLL.tb_TaskBLL.GetInstance().GetAuditTableListByUserId(pager1.PageSize, CurrentPage, " 1=1 and  ActiveType=3 " + where, out allCount);
