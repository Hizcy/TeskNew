    ...
    <form id="form1" runat="server">
       ...
       <div id="nav" class="daohang">
        ...
        <div style="width: 100%; margin: auto; overflow: hidden;">
            <img src="../images/banner.jpg" style="width: 100%; margin-top: -1%;" />
            <img usemap="#banner2" src="images/banner2.jpg" style="width: 100%; margin-top: -0.2%;" />
            <map name="banner2" id="banner2">
                <area shape="rect" coords="1435,330,1180,263" href="Register.aspx" target="_blank" alt="test" />
            </map>
        ...
        <div style="width: 100%; margin: auto; ">
         ...
         <div style="width: 100%; margin: auto; font-family: '微软雅黑';font-size:15px;">
            <img src="../images/shike.png" style="margin-left: 25%; margin-top: 2%;" />
            ...
            <img src="../images/shike.png" style="margin-left: 25%; margin-top: 0.5%;" />
