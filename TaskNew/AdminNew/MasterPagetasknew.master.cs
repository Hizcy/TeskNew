    ...
    protected string GetFirst()
    {
        ...
        menu = "<div class=\"click_info\"><a href=\"" + path + "user/Index.aspx\" class=\"{11}\" style=\"color: #FF4E00\">商家中心</a></div>"
           + " <div class=\"info_nav_main\" id=\"left_muen\">"
                            ...
                            + "</div>"
                            + "<div>"
                                + "<h3 class=\"menuheader expandable\">拍A发B管理</h3>"
                                + "<ul class=\"categoryitems\" style=\"display:block;\">"
                                    + "<li><a href=\"" + path + "busines/addGoodsb.aspx\" class=\"{4} \">发布拍A发B</a></li>"
                                    + "<li><a href=\"" + path + "busines/TaskListAB.aspx\" class=\"{5} \">拍A发B商品管理</a></li>"
                                    + "<li><a href=\"" + path + "busines/TaskAB.aspx\" class=\"{6} \">拍A发B订单管理</a></li>"
                                + "</ul>"
                            + "</div>"
                            + "<div>"
                               + " <h3 class=\"menuheader expandable\">问答任务管理</h3>"
                               + " <ul class=\"categoryitems\" style=\"display:block;\">"
                                   + " <li><a href=\"" + path + "busines/addQuestion.aspx\" class=\"{7} \">发布流量任务</a></li>"
                                   + " <li><a href=\"" + path + "busines/TaskWena.aspx\" class=\"{12} \">流量任务管理</a></li>"
                                   + " <li><a href=\"" + path + "busines/TaskWen.aspx\" class=\"{13} \">流量订单管理</a></li>"
                                + "</ul>"
                           + " </div>"
                            + "<div>"
