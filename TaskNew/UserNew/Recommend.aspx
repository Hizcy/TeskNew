                              ...
                              <div class="newgoods-wraps one-tmall main ">
                                    ...
                                    <div class="nr" >
        			                    ...
        			                    <a href="Details.aspx?id=<%#Eval("Id") %>" target="_blank" class="piwik_link ect zuixingoods-tit dsb"><%#Eval("ActiveName").ToString().Length>10?Eval("ActiveName").ToString().Replace("%20","").Substring(0,8)+"…":Eval("ActiveName").ToString().Replace("%20","") %> 
                                            <span style="float:right;font-size:13px;padding:2px;color: #ff0077;height: 20px;line-height: 20px;margin-top: 3px;"><%#type(Eval("ActiveType").ToString()) %></span></a>						
        			                    <p class="newgoods-pai zoom">
        	                                 <span style="font-size:16px;color:#ff0077">¥</span><span class="newgoods-pricej"><%#money(Eval("Price").ToString()) %></span><span class="newgoods-time" style="float:right;margin-top:15px">限量：<%#Eval("ProductNum") %>份</span>
        	                            </p>
                                        <div class="newgoods_div">
                                           <a href="Details.aspx?id=<%#Eval("id") %>"   target="_blank" class="piwik_link newgoods1_div_a" >立即申请</a>
                                        </div>
                                    </div>
                            </div>
                        </ItemTemplate>
