...
<body id="top">
  ...
  <%--  <a href="<%=path %>quan/YouHuiQuan.aspx"><img src="<%=path %>images/banner_top.jpg" style="width: 100%;"/></a>--%>
        <div class="dingceng">
        ...
        <!------------------------------------------导航结束------------------------------------------------>
            ...
            <ul>
                <li>
                    <img src="images/bannerUAR-1.png"<%-- style="margin-top: -6px;"--%> />
                    <img src="images/bannerUAR-2.png" style="margin-top: -6px;" />
                    <img src="images/bannerUAR-3.png" style="margin-top: -6px;" />
                </li>
            </ul>
        </div>
        <!------------------------------------------最底部开始------------------------------------------------>
      ...
      <%--  <div id="div">
          ...
          <div class="style_shenhui_11">
            <div class="diceng2">
                            ...
                            <tr>
                                <td class="td_1">
                                    <ul>
                                        ...
                                        <li class="li_2">|</li>
                                        <li class="li_3"><a href="<%=path %>sjbd.html" target="_blank" class="dingcheng_14" style="color: #d8d8d8">商家入驻</a></li>
                                        <li class="li_2">|</li>
                                        <%--<li class="li_1"><script charset="utf-8" type="text/javascript" src="http://wpa.b.qq.com/cgi/wpa.php?key=XzkzODA0NDA4NV8zNzUzOTBfNDAwMDA4MjYxOF8"></script></li>
                                        <li class="li_2">|</li>--%>
                                        <li class="li_5"><a href="<%=path %>Helper.asp" target="_blank" class="dingcheng_14" style="color: #d8d8d8">试用流程</a></li>
                                        <li class="li_2">|</li>
                                        <li class="li_5"><a href="<%=path %>skbd.aspx" target="_blank" class="dingcheng_14" style="color: #d8d8d8">试客帮助</a></li>
                                        <li class="li_2">|</li>
                ...
                <div class="td_12" style="margin: auto;margin-top:10px">
                    <ul>
                        <li class="li_5">
            ...
            <div style="width: 100%; text-align: center; margin-top: 15px; height: 170px;">
                ...
                <div style="float: left; margin-left: 30px;">
                    <img src="/images/dibuweixin.png" style="width: 120px;height: 120px;" />
                </div>
            </div>
            <div style="width: 100%; float: left; margin-left: 38%; margin-top: -50px;">
                <a key="56e67eccefbfb0180061dee0" logo_size="124x47" logo_type="realname" href="http://www.anquan.org ">
                    <script src="http://static.anquan.org/static/outer/js/aq_auth.js"></script>
                </a>
                <a href="https://www.yunaq.com/analytics/login/?site=www.91zhepingou.com" target="_blank" style="margin-left:10px;">
                    <img src="images/logo2.png" style="margin-left: 94px;" /> 
                </a>
            </div>
  </div>
    </form>
