    ...
    <form id="form1" runat="server">
     <div class="dingceng">
        ...
        <!------------------------------------------导航结束------------------------------------------------>
            ...
            <ul>
                <li>
                    <img src="images/bannerAAA-1.png" <%--style="margin-top: -10px;"--%>/>
                    <img src="images/bannerAAA-2.png" style="margin-top: -6px;" />
                    <img src="images/bannerAAA-3.png" style="margin-top: -6px;" />
                    <img src="images/bannerAAA-4.png" style="margin-top: -6px;" />
                    <img src="images/bannerAAA-5.png" style="margin-top: -6px;" />
                    <img src="images/bannerAAA-6.png" style="margin-top: -6px;" />
                    <img src="images/bannerAAA-7.png" style="margin-top: -6px;" />
                    <img src="images/bannerAAA-8.png" style="margin-top: -6px;" />
                </li>
            </ul>
        </div>
        <!------------------------------------------最底部开始------------------------------------------------>
