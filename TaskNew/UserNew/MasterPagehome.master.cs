...
public partial class MasterPagehome :System.Web.UI.MasterPage
{
    ...
    protected string GetFirst()
    {
        ...
        menu = "<ul><li><a href=\"" + path + "home.aspx\"  class=\"{0}\" rel=\"nofollow\">{8}</a></li>"
                    ...
                    + "<li><a href=\"" + path + "youhuiquan\" class=\"css {1}\">优惠券<span class=\"ico_mall ico_mall_menuhot\"></span></a></li>"
            ...
            // + "<li style=\"float: right;\"><a href=\"" + path + "sellerIn.html\" target=\"_blank\" class=\"css {7}\" rel=\"nofollow\" >商家入驻</a></li></ul>";
                   + "<li style=\"float: right;\"><a href=\"" + path + "sjbd.aspx\" target=\"_blank\" class=\"css {7}\" rel=\"nofollow\" style=\"color:#FF0099;font-weight:600;font-size:16px;margin-right:-21px;\">商家必读</a></li>"
                    + "<li style=\"float: right;\"><a href=\"" + path + "skbd.aspx\" target=\"_blank\" class=\"css {7}\" rel=\"nofollow\" style=\"color:#FF0099;font-weight:600;font-size:16px;border-right: 1px #ebebeb solid;height: 25px;\">试客必读</a></li>"
                   + "<li style=\"float: right;\"><a href=\""+bbs+"bbs/index.aspx\" target=\"_blank\" class=\"css {7}\" rel=\"nofollow\" style=\"color:#FF0099;font-weight:600;font-size:16px;border-right: 1px #ebebeb solid;height: 25px;\">论坛</a></li></ul>";
