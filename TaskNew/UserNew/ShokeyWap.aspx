<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShokeyWap.aspx.cs" Inherits="ShokeyWap" %>
...
<%--    <a href="<%=path %>Super.aspx"><img src="<%=path %>images/banner_top.jpg" style="width: 100%;"/></a>--%>
        ...
        <%--试客使用流程--%>
            ...
            <ul>
                <li>
                    <img src="images/banner1MUAA.png" <%--style="margin-top: -10px;"--%>/>
                    <img src="images/banner2MUAA.png" style="margin-top: -6px;"/>
                    <img src="images/banner3MUAA.png" style="margin-top: -6px;"/>
                    <img src="images/banner4MUAA.png" style="margin-top: -6px;"/>
                    <img src="images/banner5MUAA.png" style="margin-top: -6px;"/>
                    <img src="images/banner6MUAA.png" style="margin-top: -6px;"/>
                    <img src="images/banner7MUAA.png" style="margin-top: -6px;"/>
                    <img src="images/banner8MUAA.jpg" style="margin-top: -6px;"/>
                    <img src="images/banner9MUAA.jpg" style="margin-top: -6px;"/>
                    <img src="images/banner10MUAA.jpg" style="margin-top: -6px;"/>
                    <img src="images/banner11MUAA.jpg" style="margin-top: -6px;"/>
                    <img src="images/banner12MUAA.jpg" style="margin-top: -6px;"/>
                    <img src="images/banner13MUAA.jpg" style="margin-top: -6px;"/>
                    <img src="images/banner14MUAA.jpg" style="margin-top: -6px;"/>
                    <img src="images/banner15MUAA.jpg" style="margin-top: -6px;"/>
                </li>
            </ul>
        </div>
        <!------------------------------------------最底部开始------------------------------------------------>
