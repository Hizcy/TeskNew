 ...
 <%--   <a href="<%=path %>Super.aspx"><img src="<%=path %>images/banner_top.jpg" style="width: 100%;"/></a>--%>
    <div class="dingceng">
        ...
        <%--试客使用流程--%>
            ...
            <ul>
                <li>
                    <img src="images/bannerUAA-1.png" <%--style="margin-top: -10px;"--%>/>
                    <img src="images/bannerUAA-2.png" style="margin-top: -6px;" />
                    <img src="images/bannerUAA-3.png" style="margin-top: -6px;" />
                    <img src="images/bannerUAA-4.png" style="margin-top: -6px;" />
                    <img src="images/bannerUAA-5.png" style="margin-top: -6px;" />
                    <img src="images/bannerUAA-6.png" style="margin-top: -6px;" />
                    <img src="images/bannerUAA-7.png" style="margin-top: -6px;" />
                    <img src="images/bannerUAA-8.png" style="margin-top: -6px;" />
                    <img src="images/bannerUAA-9.png" style="margin-top: -6px;" />
                    <img src="images/bannerUAA-10.png" style="margin-top: -6px;" />
                    <img src="images/bannerUAA-11.png" style="margin-top: -6px;" />
                </li>
            </ul>
        </div>
        <!------------------------------------------最底部开始------------------------------------------------>
