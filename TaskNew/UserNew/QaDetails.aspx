            ...
            <div class="main">
                <div class="detail_licheng">
                    <div class="detail_main">
                        <div class="detain_pro"><img src="<%=img %>" width="260" height="260" onerror="this.src='<%=path %>images/quesheng.jpg'"/></div>
                ...
                <div class="deta_pl">
                    ...
                    <div class="detail_xingqer" style="display:block">
                        ...
                        <div class="div-column">
                            ...
                            <div class="cour_div">
                                ...
                                <p class="cour_div_top_10"><img src="<%=path %>images/taobao_stro_all.gif"/></p>
                            </div>
                            <div class="cour_div">
                                <p class="cour_div_p38"><span class="cour_p_span">3、</span>按照 <font color="#C00">综合排序</font> 搜索（<%=Description %>）.</p>
                                <p class="cour_div_top_10">
                                    <%if(Orderby==1){ %>
                                    <img src="<%=path %>images/zonghe.jpg" onerror="this.src='<%=path %>images/quesheng.jpg'"/>
                                    <%}else if(Orderby==2){ %>
                                    <img src="<%=path %>images/renqi.jpg" />
                                    <%}else{ %>
                                    <img src="<%=path %>images/xiaoliang.jpg" onerror="this.src='<%=path %>images/quesheng.jpg'"/>
                                    <%} %>
                                    <%--<img src="<%=Orderby %>"/></p>--%>
                            </div>
                            <div class="cour_div">
                            ...
                            <div class="cour_div">
                                ...
                                <p class="cour_div_top_10"><img src="<%=AnwserImage %>" onerror="this.src='<%=path %>images/quesheng.jpg'"/></p>
                                <br/>
                                <p class="cour_div_p38"><span class="cour_p_span">6、</span>将以上图片找到的答案,输入到答案框内并点击 “提交答案”。</p>
                                <p class="cour_div_top_10"><img src="<%=path %>images/task_answer.gif" width="459" height="59" onerror="this.src='<%=path %>images/quesheng.jpg'"/></p>
                            </div>
                        </div>
                    </div>
                    <%}else{ %>
                    <div id="dy2" class="cont" style="display:block;">
						<dl class="f14">
                            <span style="height:30px;line-height:30px;margin:16px;">折品购官方QQ群：</span><a target="_blank" href="http://shang.qq.com/wpa/qunwpa?idkey=12a3056433541aed092dede1b0e251a12f7767ff0cd7684fb0f8e5ab8f814dff"><img src="<%=path %>images/qq_qun.gif" style="margin:-7px"/></a><span style="margin-left:30px">或搜索群号码:231108692</span>
    ...
    <script>
     ...
     //   $("#SubmitAnswer2").click(function () {
            ...
            if (qid == 0) {
                ...
                window.location.href = "<%=path %>QaDetails.aspx?id=<%=id%>";
                return;
            }
            var id = "<%=id%>";
