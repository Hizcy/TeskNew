<%@ Page Title="试用任务管理记录-91折品购" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="RecordShi.aspx.cs" Inherits="users_RecordShi" %>
            ...
            <div class="mod_taber mod_taber0">
                <div class="mod_taber_hd">
                    <ul class="mod_hlist mod_taber_menu" id="tags_menu">
                        <li><a href="RecordShi.aspx" id="shi"><span>全部试用</span></a></li>
                        <li><a href="RecordShi.aspx?status=0" id="shi0"><span>待审核</span></a></li>
                        <li><a href="RecordShi.aspx?status=-1" id="shi1"><span>取消资格</span></a></li>
                        <li><a href="RecordShi.aspx?status=1" id="shi6"><span>通过审核</span></a></li>
                    </ul>
                </div>
                <div class="mod_taber_bd">
                    <div class="mod_taber_bd">
                                    ...
                                    <asp:Repeater ID="rptTaskList" runat="server">
                                        <ItemTemplate>
                                            <tr onmouseover="$(this).addClass('hover');" onmouseout="$(this).removeClass('hover');"  class="">
                                                <td class="cell2">
                                                    <%#img(int.Parse(Eval("audit").ToString())) %>
                                                </td>
                                                <td class="cell3 div_images_item"><a href="<%=homeUrl %>Details.aspx?id=<%#Eval("TaskId") %>&_g=<%=gu %>" target="_blank" onmousemove="$(this).next().show()" onmouseout="$(this).next().hide()"><font color="#09f"><label style="width:150px;display:block;overflow:hidden;white-space:nowrap;"><%#Eval("ActiveName") %></label></font></a>
                                                <div style="position: absolute; display: none;"><img src="<%#imgUrlReplace(Eval("ProductImage").ToString()+"-jpg279","s") %>" width="100" height="100"></div></td>
                                                ...
                                                <td class="cell6 cell_acts" id="type<%#Eval("Id") %>">
                                                    <%#returnStatus(Convert.ToInt32(Eval("Audit").ToString()),Eval("Id").ToString()) %></td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
                        ...
                        <div class="mod_taber_page_ft" style="text-align:center"><!-- S 组件pager -->
                            <webdiyer:AspNetPager ID="pager1" CssClass="paginator"   CurrentPageButtonClass="cpb" runat="server" AlwaysShow="True" 
                                ...
                                ShowInputBox="Never" onpagechanged="AspNetPager1_PageChanged"  CustomInfoTextAlign="Left" Font-Size="14px" ForeColor="#f60" PagingButtonSpacing="7px"  >
