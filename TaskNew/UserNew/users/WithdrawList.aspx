                                    ...
                                    <table class="i_mod_tableA">
                                        ...
                                        <tbody>
	                                        <tr>
		                                        ...
		                                        <th scope="col" style="width:70px;">充值方式</th>
                                                <th scope="col" style="width:180px;">支付宝号</th>
		                                        <th scope="col" style="width:100px">提现金额(元)</th>
		                                       <%-- <th scope="col" style="width:60px">优惠比率</th>--%>
                                                <th scope="col" style="width:170px;">审核时间</th>
                                            ...
                                            <asp:Repeater runat="server" ID="rpttixian">
                                                    <ItemTemplate>
                                                        <tr onmouseover="$(this).addClass('hover');" onmouseout="$(this).removeClass('hover');" id="msg_k_6793" class="">
                                                            <td class="cell2">
			                                                    <img src="../images/withdraw_off.gif" width="16" height="16">
		                                                    </td>
		                                                  ...
		                                                  <%--  <td class="cell4"><font class="i_money"><%#Eval("Rate") %></font></td>--%>
