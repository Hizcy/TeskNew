...
public partial class users_Require :BasePage// System.Web.UI.Page
{
    ...
    public string activemethod = "";//0：电脑或者1：手机单
    ...
    private void BindData()
    {
        if (id > 0)
        {
            DataSet ds = Task.BLL.tb_TaskBLL.GetInstance().Get_tb_useridList(id, identity.UserID);
