        ...
        if (!IsPostBack)
        {
            if (identity != null)
            {
                ...
                if (ds != null && ds.Tables.Count > 0 && ds.Tables[0] != null && ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    {
                        stateExam = "<div style=\"text-align:center;margin-top: 19px\"><a href=\"../startExam.aspx\">开始测试</a>&nbsp;&nbsp;&nbsp;&nbsp;<font color=\"red\">亲，测试通过奖励金币噢！</font><a href=\"http://www.zhepingou.com/bbs/showtopic-4.aspx\" target=\"_blank\" style=\"color:red\">(如何获得更多金币？)</a></div>";
                    }
                }
                ...
                //获取所有公告
                IList<Task.Entity.tb_ArticleEntity> list = Task.BLL.tb_ArticleBLL.GetInstance().Get_tb_ArticletopList(1);
                if(list!=null)
                {
