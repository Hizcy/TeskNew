...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 <!--
   <div class="suspend_bottom" style="display:none">
    ...
    -->
    <div class="w1000 zoom" style="overflow:hidden">  
        <!--老版-->     
        ...
        <div style="width: 1200px;margin: auto;">
           ...
           <div class="cata_types">
                <div class="cate_types_list">
                    <span>试用平台：</span>
                    <div class="choose_1">
                        <a href="DetailsList.aspx?pid=0">全部</a>
                        <a href="?pid=1">淘宝</a>
                        <a href="?pid=2">天猫</a>
                    </div>
                </div>
    	                  ...
    	                  <ul class="div" style=" background-color: white;margin: 2px;margin-top:10px;">
                             <li class="zoom today-temai-navxb">
                                ...
                                <p style="">
                                    ...
                                    <%#Eval("ActiveName").ToString().Replace("%20","") %>
                                </p>
                                ...
                                <p>
                                    ...
                                    <span class="r">已关注：<i><%#Eval("guanzhu") %></i>次</span>
                                </p>
                                <p class="apply">
