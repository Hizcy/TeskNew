        ...
        <div class="logo_1">
            <div class="logo_1_1">
                <a href="<%=wwwpath %>home.aspx" target="_blank">
                    <img src="../images/shangjilogo1.png" alt="折品购" class="logo_img" style="width:370px" /></a>
            </div>
            <div class="logo_1_2">
...
<%--                       <li class=""><a href="<%=path %>skbd.aspx" target="_blank"><p style="color: #FF0099;font-weight: 600;font-size: 16px;">试客必读</p></a><span></span></li>--%>
        ...
        <!------------------------------------------导航开始结束------------------------------------------------>
        <div>
            <a href="<%=adminurl%>register.aspx"target="_blank">
            <img src="images/shangjiaruzhu2.jpg" style="width: 100%;" /></a>
            <%-- <img src="images/banner3.jpg" style="width: 100%;margin-top: -1%;"/>--%>
           <%-- <img usemap="#banner3"  src="images/banner3.jpg" style="width: 100%; margin-top: -1%;" />
            <map name="banner3" id="banner3">
                <area shape="rect" coords="1180,141,768,252" href="<%=adminurl%>register.aspx" target="_blank" alt="test" />
            </map>--%>
        ...
        <%--        <div style="width:100%;overflow:hidden;">
            <img src="../images/shike1.png" style="margin-left: 23%; margin-top: 2%;" />
            ...
            <p style="margin-left: 25%; margin-top: -1.2%; font-family: '微软雅黑';">2800元/年，全年可在平台不限次数的发布试用任务，新用户可以免费体验一个月</p>
            <img src="../images/shike1.png" style="margin-left: 23%;" />
            <p style="margin-left: 25%; margin-top: -1.2%; font-weight: bolder;">你们平台一个ID最多可以绑定几个店铺？</p>
            <img src="../images/kefu.png" style="margin-left: 23%; margin-top: -1%;" />
            <p style="margin-left: 25%; margin-top: -1.2%;">一个ID最多可以绑定5个店铺，并且每个店铺绑定都是免费的</p>
            <img src="../images/shike1.png" style="margin-left: 23%;" />
            ...
            <p style="margin-left: 25%; margin-top: -0.5%;">1.通过支付宝实名认证</p>
            <p style="margin-left: 25%; margin-top: -0.5%;">2.淘宝买号2心信誉以上</p>
            <p style="margin-left: 25%; margin-top: -0.5%;">3.需要添加身份证信息验证</p>
            <p style="margin-left: 25%; margin-top: -0.5%;">杜绝一切小号或危险账号，申请商家的试用任务，买号安全性可以得到保障</p>
            <br />
            <br />
        </div>--%>
        <div style="font-family: '微软雅黑';font-size:15px;">
            ...
            <div>
                ...
                <p style="margin-left: 25%; margin-top: -1.1%; ">2800元/年，全年可在平台不限次数的发布试用任务，新用户可以免费体验一个月</p>
            </div>
            <div>
                <img src="../images/shike1.png" style="margin-left: 23%;margin-top: 0.5%;" />
