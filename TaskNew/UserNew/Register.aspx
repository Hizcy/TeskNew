                    ...
                    <div class="rule-list">
                            ...
                            <div class="reg-switch-box J_switch_box">
                                <div class="J_login Fix">
                                    <ul class="login-new-ul">
                                        ...
                                        <li class="J_action">
                                             <asp:Button style="background-color:#ff0099;font-weight: bolder;padding:10px;border-radius:5px;margin-left:80px;color: #fff;font-size: 18px;width:208px;border: 0;" ID="Button1" runat="server" Text="注册" OnClick="btnZC_Click" OnClientClick="registered()" />
                                        <label for="recommend_chk" style="margin-top:16px; margin-left:20px;">
                                            <input canempty="ture" checkurl="ture" disabled="disabled" regname="recommend_chk" type="checkbox" checked="checked" name="login_remember" pass="1" old="1"><i style="color:#1d1c1c">我同意</i>
                                           	<a style="color:#161515" target="_blank">折品购服务协议</a>
                                        </label>                        
                                        </li>
                        ...
                        <div class="aside-right-new">
                            ...
                            <a class="aside-right-buy-btn m-lbtn" href="login.aspx"><span>立即登录</span></a>
                             <div class="right-info" style="height:inherit; margin-top:60px; padding:30px 20px;"><span style="color:#f00;">严禁注册多个试客账号，一经发现，直接封号！本金不予提现！</span><br>欢迎加入试客新人QQ群：<br><span style="color:#f00;">291403632</span>，和其他试客一起分享、交流信息，群内有人一对一带教，带你轻松玩转试用！</div>
                        </div>
                    </div>
                </div>
            </div>
