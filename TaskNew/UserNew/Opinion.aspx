                                ...
                                <asp:Repeater runat="server" ID="rptjiangli">
                                    <ItemTemplate>
                                        <tr style="color:#808080;height: 40px; word-wrap: break-word; word-break: break-all;">
                                            <td style="font-size:15px;text-align:center"><%#(Eval("Mobile").ToString().Length>8?Eval("Mobile").ToString().Replace("%20","").Substring(0,6)+"…":Eval("Mobile").ToString().Replace("%20","") ) %></td>
