        ...
        <!------------------------------------------导航结束------------------------------------------------>
            ...
            <div >
                <div style="text-align: center;">
                        <img src="images/bannerAAR-1.png"<%-- style="margin-top: -10px;"--%>/>
                        <img src="images/bannerAAR-2.png" style="margin-top: -6px;" />
                        <img src="images/bannerAAR-3.png" style="margin-top: -6px;" />
                </div>
            </div>
        <!------------------------------------------最底部开始------------------------------------------------>
