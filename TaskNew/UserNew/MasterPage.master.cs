...
public partial class MasterPage :System.Web.UI.MasterPage
{
        ...
        if (!IsPostBack)
        {
            ...
            if (identity != null)
            {
                ...
                if (model != null)
                {
                    ...
                    herd = BasePage.imgUrlReplace(model.Header + "-jpg279", "s");
                    id = identity.UserID;
                }
    ...
    protected string GetFirst()
    {
        ...
        string quandingdan = Jnwf.Utils.Config.ConfigurationUtil.GetAppSettingValue("quandingdan");//优惠券订单
                        ...
                        + "<ul>"
                            ...
                            +"<h3 class=\"menuheader openheader\" style=\"color:#808080\">订单管理</h3>"
                              ...
                              +"  </li>"
                               ...
                               + " <a class=\"aa\">拍A发B任务</a>"
                                +"    <ul class=\"subcategoryitems\" style=\"display: block;\">"
                                       + "<li><a href=\"" + path + "users/TtadelistYong.aspx\" class=\"{3}\">拍A发B管理</a></li>"
                                       +"<li><a href=\"" + path + "users/RecordYong.aspx\" class=\"{2}\">拍A发B申请记录</a></li>"
                                  +"  </ul>"
                               +" </li>"
                               + " <li>"
                               + " <a class=\"aa\">优惠券</a>"
                                + "    <ul class=\"subcategoryitems\" style=\"display: block;\">"
                                       + "<li><a href=\"" + path + "users/TtadelistQuan.aspx\" class=\"{9}\">优惠券管理</a></li>"
                                  + "  </ul>"
                               + " </li>"
                                + " <li>"
                               + " <a  class=\"aa\">流量任务</a>"
                                + "    <ul class=\"subcategoryitems\" style=\"display: block;\">"
                                   + "     <li><a href=\"" + path + "users/TradelistWen.aspx\" class=\"{7}\">流量任务统计</a></li>"
                                  + "  </ul>"
                               + " </li>"
                           +" </ul>"
                     +"   </div>"
                      +"  <div>"
                         ...
                         +"   <ul class=\"categoryitems\" style=\"display:block;\">"
                             + "   <li><a href=\"" + wwwpath + "Yaoqingnew.aspx\" target=\"_blank\">我要邀请</a></li>"
                         +"   </ul>"
                       +" </div>"
                       +" <div>"
        ...
        else if (quandingdan.IndexOf("," + arr[2].ToLower() + ",") >= 0)
        {
            return string.Format(menu, "", "", "", "", "", "", "", "", "", "liorge");
        }
