<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MerchantB.aspx.cs" Inherits="MerchantB" %>
...
<body id="top">
  ...
  <%--  <a href="<%=path %>Super.aspx"><img src="<%=path %>images/banner_top.jpg" style="width: 100%;"/></a>--%>
        ...
        <!------------------------------------------导航结束------------------------------------------------>
            ...
            <ul>
                <li>
                    <img src="images/bannerAAB-1.png" <%--style="margin-top: -10px;"--%>/>
                    <img src="images/bannerAAB-2.png" style="margin-top: -6px;" />
                    <img src="images/bannerAAB-3.png" style="margin-top: -6px;" />
                    <img src="images/bannerAAB-4.png" style="margin-top: -6px;" />
                    <img src="images/bannerAAB-5.png" style="margin-top: -6px;" />
                    <img src="images/bannerAAB-6.png" style="margin-top: -6px;" />
                    <img src="images/bannerAAB-7.png" style="margin-top: -6px;" />
                    <img src="images/bannerAAB-8.png" style="margin-top: -6px;" />
                </li>
            </ul>
        </div>
        <!------------------------------------------最底部开始------------------------------------------------>
