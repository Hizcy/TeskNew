...
public partial class StartExam : BasePage//System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            if (identity != null)
            {
                bool tflag = Task.BLL.tb_Answer_QuestionBLL.GetInstance().GetUserExamAuditBy(identity.UserID);
                if (tflag)
                {
                ...
                if (list != null && list.Count > 0)
                {
                    ...
                    foreach (Task.Entity.tb_TeskQuestionsEntity model in list)
                    {
                        ...
                        if (model.QuestionType == 1)
                        {
                            ...
                            sb.Append("<p><span style=\"font-family: 宋体; font-size: 14px;\">" + matchCouent(model.Title) + "</span></p>");
                            sb.Append("</div>");
                            sb.Append("</div>");
                            sb.Append("</div>");
                            ...
                            sb.Append("<p style=\"margin-top: 3px;\"><span style=\"font-size: 14px; color: #5c5353; letter-spacing: 2px; margin: 5px;\">" + matchCouent(model.A) + "</span></p>");
                            sb.Append("<p>");
                            sb.Append("<br />");
                            sb.Append("</p>");
                            sb.Append("</div>");
                            ...
                            sb.Append("<div class=\"f-fl\">");
                            sb.Append("<p style=\"margin-top: 3px;\"><span style=\"font-size: 14px; color: #5c5353; letter-spacing: 2px; margin: 5px;\">" + matchCouent(model.B) + "</span></p>");
                            sb.Append("<p>");
                            sb.Append("<br />");
                            sb.Append("</p>");
                            sb.Append("</div>");
                            ...
                            sb.Append("<div class=\"f-fl\">");
                            sb.Append("<p style=\"margin-top: 3px;\"><span style=\"font-size: 14px; color: #5c5353; letter-spacing: 2px; margin: 5px;\">" + matchCouent(model.C) + "</span></p>");
                            sb.Append("<p>");
                            sb.Append("<br />");
                            sb.Append("</p>");
                            sb.Append("</div>");
                            ...
                            sb.Append("<div class=\"f-fl\">");
                            sb.Append("<p style=\"margin-top: 3px;\"><span style=\"font-size: 14px; color: #5c5353; letter-spacing: 2px; margin: 5px;\">" + matchCouent(model.D) + "</span></p>");
                            sb.Append("<p>");
                            sb.Append("<br />");
                            sb.Append("</p>");
                            sb.Append("</div>");
                            ...
                            if (model.OptionsNubmer == 6)
                            {
                                ...
                                sb.Append("<div class=\"f-fl\">");
                                sb.Append("<p style=\"margin-top: 3px;\"><span style=\"font-size: 14px; color: #5c5353; letter-spacing: 2px; margin: 5px;\">" + matchCouent(model.E) + "</span></p>");
                                sb.Append("<p>");
                                sb.Append("<br />");
                                sb.Append("</p>");
                                sb.Append("</div>");
                                ...
                                sb.Append("<div class=\"f-fl\">");
                                sb.Append("<p style=\"margin-top: 3px;\"><span style=\"font-size: 14px; color: #5c5353; letter-spacing: 2px; margin: 5px;\">" + matchCouent(model.F) + "</span></p>");
                                sb.Append("<p>");
                                sb.Append("<br />");
                                sb.Append("</p>");
                                sb.Append("</div>");
                    ...
                    if (fuxList != null && fuxList.Count > 0)
                    {
                        foreach (Task.Entity.tb_TeskQuestionsEntity model in fuxList)
                        {
                            ...
                            sb.Append("<ul>");
                            sb.Append("<li class=\"f-cb\">");
                            sb.Append("<input type=\"checkbox\" class=\"u-tbi" + examNumber + "\" name=\"checkbox_" + examNumber + "\" style=\"cursor: pointer;\" value=\"A_" + model.Id + "\" />");
                            sb.Append("<div class=\"optionPos f-fl\">A.</div>");
                            sb.Append("<div class=\"f-fl\">");
                            sb.Append("<p style=\"margin-top: 3px;\"><span style=\"font-size: 14px; color: #5c5353; letter-spacing: 2px; margin: 5px;\">" + matchCouent(model.A) + "</span></p>");
                            sb.Append("<p>");
                            ...
                            sb.Append("<li class=\"f-cb\">");
                            sb.Append("<input type=\"checkbox\" class=\"u-tbi" + examNumber + "\" name=\"checkbox_" + examNumber + "\" style=\"cursor: pointer;\" value=\"B_" + model.Id + "\" />");
                            sb.Append("<div class=\"optionPos f-fl\">B.</div>");
                            sb.Append("<div class=\"f-fl\">");
                            sb.Append("<p style=\"margin-top: 3px;\"><span style=\"font-size: 14px; color: #5c5353; letter-spacing: 2px; margin: 5px;\">" + matchCouent(model.B) + "</span></p>");
                            sb.Append("<p>");
                            ...
                            sb.Append("<li class=\"f-cb\">");
                            sb.Append("<input type=\"checkbox\" class=\"u-tbi" + examNumber + "\" name=\"checkbox_" + examNumber + "\" style=\"cursor: pointer;\"  value=\"C_" + model.Id + "\" />");
                            sb.Append("<div class=\"optionPos f-fl\">C.</div>");
                            sb.Append("<div class=\"f-fl\">");
                            sb.Append("<p style=\"margin-top: 3px;\"><span style=\"font-size: 14px; color: #5c5353; letter-spacing: 2px; margin: 5px;\">" + matchCouent(model.C) + "</span></p>");
                            sb.Append("<p>");
                            ...
                            sb.Append("<li class=\"f-cb\">");
                            sb.Append("<input type=\"checkbox\" class=\"u-tbi" + examNumber + "\" name=\"checkbox_" + examNumber + "\" style=\"cursor: pointer;\"  value=\"D_" + model.Id + "\" />");
                            sb.Append("<div class=\"optionPos f-fl\">D.</div>");
                            sb.Append("<div class=\"f-fl\">");
                            sb.Append("<p style=\"margin-top: 3px;\"><span style=\"font-size: 14px; color: #5c5353; letter-spacing: 2px; margin: 5px;\">" + matchCouent(model.D) + "</span></p>");
                            sb.Append("<p>");
                            ...
                            {
                                sb.Append("<li class=\"f-cb\">");
                                sb.Append("<input type=\"checkbox\" class=\"u-tbi" + examNumber + "\" name=\"checkbox_" + examNumber + "\" style=\"cursor: pointer;\"  value=\"E_" + model.Id + "\" />");
                                sb.Append("<div class=\"optionPos f-fl\">E.</div>");
                                sb.Append("<div class=\"f-fl\">");
                                sb.Append("<p style=\"margin-top: 3px;\"><span style=\"font-size: 14px; color: #5c5353; letter-spacing: 2px; margin: 5px;\">" + matchCouent(model.E) + "</span></p>");
                                sb.Append("<p>");
                                ...
                                sb.Append("<li class=\"f-cb\">");
                                sb.Append("<input type=\"checkbox\" class=\"u-tbi" + examNumber + "\" name=\"checkbox_" + examNumber + "\" style=\"cursor: pointer;\"  value=\"F_" + model.Id + "\" />");
                                sb.Append("<div class=\"optionPos f-fl\">F.</div>");
                                sb.Append("<div class=\"f-fl\">");
                                sb.Append("<p style=\"margin-top: 3px;\"><span style=\"font-size: 14px; color: #5c5353; letter-spacing: 2px; margin: 5px;\">" + matchCouent(model.F) + "</span></p>");
                                sb.Append("<p>");
    ...
    public string matchCouent(string str)
    {
        return str.Replace("<p style=\"line-height:15px\">", "").Replace("</p>", "").Replace("<p>", "").Replace("<br/>", "");
    }
}