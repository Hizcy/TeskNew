            ...
            <div class="fl">
                ...
                <div class="m_txt">
                    <ul>
                        ...
                        <li class="red">申请成功<i class="sicon"></i></li>
                        <li>进入试用商品页</li>
                        <li>浏览店铺</li>
                        <li>客服聊天</li>
                        <li>下单并付款</li>
            ...
            <div class="fl" style="width:700px;">
                ...
                <div class="ok-box">
                    <p style="font-size:18px;">您已提交试用申请，系统将在<span>
                       <%=time %>                     </span>之后抽取试用资格</p>
                    <p style="font-size:18px;">若您获得试用资格，系统将会以手机短信的方式通知您，请根据提示完成后续任务</p>
                </div>

                <div class="ok-box1">
                    <p style="font-size:18px; padding-left:22px;" class="pb30">请在收到平台通知后于<i style="color:red;">24</i>小时内点击网站（<i style="color:red;">个人中心>试用管理</i>），完成操作并下单，若超时未操作系统将自动取消试用资格。</p>
                </div>
