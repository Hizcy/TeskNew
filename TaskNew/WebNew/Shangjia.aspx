<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Shangjia.aspx.cs" Inherits="Shangjia" %>
        ...
        <!------------------------------------------导航结束------------------------------------------------>
            ...
            <div >
                <div style="text-align: center;">
                        <img src="images2/skzhuce1.png" style="margin-top: -10px;"/>
                        <img src="images2/skzhuce2.png" style="margin-top: -6px;" />
                        <img src="images2/skzhuce3.png" style="margin-top: -6px;" />
                </div>
            </div>
        <!------------------------------------------最底部开始------------------------------------------------>
