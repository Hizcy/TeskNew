<%@ Page Title="充值记录" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="RechargeList.aspx.cs" Inherits="core_RechargeList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <div class="corechongzhi">
                  <div class="zhongXinycz clr">
                    <div class="chongzhi">
                            <ul>
                                <a href="TaskList.aspx"><li>交易记录</li></a>
                                <a href="RechargeList.aspx" style="color:#fff"><li style="background-color:#0f91b8">充值记录</li></a>
                                <a href="WithdrawList.aspx"><li>提现记录</li></a>
                            </ul>
                    </div>
                  </div>
           </div>
            <div class="corechongzhi-2">
                  <div class="zhongXinycz-2 clr">
                       <div class="chongzhi-1">
                            ...
                            <table style="width:1200px;margin:auto;margin-top:20px;" >
                                ...
                                <tr>
                                    ...
                                    <th style="width:15%;text-align:center">充值金额</th>
                                    <th style="width:10%;text-align:center">优惠比率</th>
                                    <th style="width:15%;text-align:center">充值时间</th>
                                    <th style="width:20%;text-align:center">审核进度</th>
                                </tr>
                                </tbody>
                                <asp:Repeater runat="server" ID="rptmonery">
                                    <ItemTemplate>
