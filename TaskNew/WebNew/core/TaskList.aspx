<%@ Page Title="交易记录" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="TaskList.aspx.cs" Inherits="core_TaskList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     ...
     <div class="corerenwu">
                  <div class="zhongXinyrw clr">
                    <div class="renwu">
                            <ul>
                                <a href="TaskList.aspx" style="color:#fff"> <li style="background-color:#0f91b8;">交易记录</li></a>
            ...
            <div class="corerenwu-2">
                  <div class="zhongXinyrw-2 clr">
                      <div class="renwu-1">
                           ...
                           <table style="width:1200px;margin:auto;margin-top:20px;" >
                                ...
                                <tr>
                                    ...
                                    <th style="width:20%;text-align:center">交易时间</th>
                                    <th style="width:20%;text-align:center">状态</th>
                                </tr>
                                </tbody>
                                <asp:Repeater runat="server" ID="rptjiaoyi">
                                    <ItemTemplate>
