...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div style="background-image: url(images2/banner-01.png);background-repeat:no-repeat;background-attachment:scroll;height:660px;margin:0 auto;background-size: 100% 100%;">
            <%--<img src="images2/banner.png" style="width: 100%;"/>--%>
        <div style="margin:0 auto;width:999px;">
            <div style="position:relative; right:-68px; bottom:-432px; width:1000px; height:584px">
                <div style="background-image: url(images2/daolu.png);background-repeat:no-repeat;height: 420%;line-height: 50px;">
                    <%-- 你可以 或者 --%>
            <div style="margin:0 auto;width:1090px;padding: 50px 0;">
                <%-- 没登录前 --%>
                <%if (id == 0){ %>
                <div style="width:1090px;height:540px;background-image:url(images2/img01.png);background-repeat:no-repeat;">
                    <div style="width:1000px;padding: 256px 0;height:840px;">
                        <a href="<%=userurl %>login.aspx" target="_blank" style="cursor:pointer"><img src="images2/denglu.png" style="float:right;margin-right: 222px;" /></a>
                    </div>
                </div>
                <%}else{ %>
                <%--登陆后  --%>
                <div style="width:1090px;height:540px;background-image:url(images2/fenxiang.png);background-repeat:no-repeat;">
                   <div style="width:1000px;padding:160px 0;margin-left: 50px;">
                       <div style="float:left;width:410px" class="share-con">
                           ...
                           <a  style="margin-left:70px; cursor: pointer;" >
                              <img  class="copy_btn" onclick="copy()"  src="images2/yijianfuzhi.png"/>
                           </a></p>
                       ...
                       <div style="float:left;width:400px;margin-left:120px">
                           ...
                           <p>
                               <span>
                                    <a href="javascript:void(0)"   onclick="Share.qqZone('快快邀请你的朋友们吧','http://user.91zhepingou.com/register.aspx?id=<%=str %>','');" class="tmblog q" title="分享到QQ空间"><img src="images2/kongjian.png" /></a>
                               </span>
                               <span>
                                   <a href="javascript:void(0)"   onclick="Share.sinaWeiBo('快快邀请你的朋友们吧','http://user.91zhepingou.com/register.aspx?id=<%=str %>','');" title="分享到腾讯微博"><img src="images2/xinlang.png" /></a>
                               </span>
                               <span>
                                   <a href="javascript:void(0)" onclick="Share.qqHaoyou('快快邀请你的朋友们吧','http://user.91zhepingou.com/register.aspx?id=<%=str %>','');" title="分享到QQ好友"><img src="images2/qq.png" /></a>
                               </span>
                            <%--   <span>
                                   <a href="javascript:void(0)" onclick="Share.weChat('','http://user.91zhepingou.com/register.aspx','');" title="分享到微信"><img src="images2/weixin.png" /></a>
                               </span>--%>
                               <span style="margin-left: 40px;">
                                   <img src="images2/kuangtu.png" />
                               </span>
                           </p>
                       </div> 
                   </div>
                ...
                <%} %>
                        ...
                        <%--  邀请排行榜--%>
                <div style="background-image:url(images2/img02.png);background-repeat: no-repeat;margin:0 auto;width:1090px;margin-top: 10px;">
                <div style="width:1090px;height:840px;background-image:url(images2/yaoqingbang.jpg);background-repeat:no-repeat;">
            ...
            <%--  邀请奖励--%>
            <div style="background-image:url(images2/img03.png);background-repeat: no-repeat;margin:0 auto;width:1090px;margin-top: 40px;">
               <div style="width:1090px;height:840px;background-image:url(images2/img03.jpg);background-repeat:no-repeat;"> 
