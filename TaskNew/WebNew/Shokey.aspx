<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Shokey.aspx.cs" Inherits="Shokey" %>
...
<body id="top">
    ...
    <a href="<%=path %>Super.aspx"><img src="<%=path %>images2/banner_top.jpg" style="width: 100%;"/></a>
        <div class="dingceng">
                    ...
                    <tr>
                        ...
                        <td class="td_1">
                            <ul>
                                ...
                                <li class="li_2">|</li>
                                <li class="li_4"><a href="<%=path %>New.aspx" target="_blank" class="dingcheng_12">试用流程</a></li>
                                <li class="li_2">|</li>
        ...
        <div class="logo_1">
            <div class="logo_1_1">
                <a href="<%=path %>">
                    <img src="<%=path %>images2/logo-2.png" alt="折品购" class="logo_img" /></a>
            </div>
                <div class="shikenliebiao" style="float: left;height: 90px;position: relative;">
                    ...
                    <ul style="position: relative;">
                        <li style="list-style-type: none;float: left;text-align: center;padding: 0 25px;line-height: 77px;">
                            <a href="<%=path %>"><span class="logo_1_2_1" style="font-size:20px;">首页</span></a>
                        </li>
        ...
        <%--试客使用流程--%>
            ...
            <ul>
                <li>
                    <img src="images2/skliucheng1.png" style="margin-top: -10px;"/>
                    <img src="images2/skliucheng2.png" style="margin-top: -6px;" />
                    <img src="images2/skliucheng3.png" style="margin-top: -6px;" />
                    <img src="images2/skliucheng4.png" style="margin-top: -6px;" />
                    <img src="images2/skliucheng5.png" style="margin-top: -6px;" />
                    <img src="images2/skliucheng6.png" style="margin-top: -6px;" />
                    <img src="images2/skliucheng7.png" style="margin-top: -6px;" />
                    <img src="images2/skliucheng8.png" style="margin-top: -6px;" />
                </li>
            </ul>
        </div>
        <!------------------------------------------最底部开始------------------------------------------------>
        ...
        <div id="div">
            <div style="float: left;clear: left;border:1px solid red;text-align:center;line-height:75px;font-size:33px;font-weight:bold;">
                <div class="divkuang" style="background:#c40001; color:#FFF"; >折品购试客招募中···<img src="images2/点击加入按钮.png" width="130" height="55" style="vertical-align:middle;" /></div>
             </div>
        </div>
