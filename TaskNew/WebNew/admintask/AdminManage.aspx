<%@ Page Title="试用任务管理" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AdminManage.aspx.cs" Inherits="admintask_AdminManage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
         <div class="corezlcd">
            <div class="zhongXincorezlcd clr">
                <div class="caidan">
                    <ul>
                        <li><a href="AdminManage.aspx" class="a-1">试用任务</a></li>
                        <li><a href="AdminYong.aspx" >佣金任务</a></li>
                        <li><a href="AdminQa.aspx" >问答任务</a></li>
                    </ul>
                </div>
            </div> 
        </div>
     <div class="corezlcdtask">
            <div class="zhongXincorezlcd clr">
                <div class="caidan">
                    <ul>
                        <li><a href="AdminManage.aspx" id="qb">全部</a></li>
                        <li><a href="AdminManage.aspx?status=-6" id="fk">待付款</a></li>
                        <li><a href="AdminManage.aspx?status=0" id="sh">待审核</a></li>
                        <li><a href="AdminManage.aspx?status=1" id="tg">审核通过</a></li>
                        <li><a href="AdminManage.aspx?status=-1" id="sb">审核失败</a></li>
                    </ul>
                </div>
            </div> 
        </div>
            ...
            <ItemTemplate>
                <tr style="border-bottom:1px dashed  #0f91b8;height:50px;">
                    ...
                    <td style="width:16%;text-align:center">
                        <%#orderStatus(int.Parse(Eval("ActiveAudit").ToString()))%> <a href="Detail.aspx?id=<%#Eval("id") %>" style="color:#f60;">详情</a>
                    </td>
                </tr>
            </ItemTemplate>
        </asp:Repeater>
