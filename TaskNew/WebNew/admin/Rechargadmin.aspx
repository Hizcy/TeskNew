<%@ Page Title="用户提现审核" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Rechargadmin.aspx.cs" Inherits="admin_Rechargadmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="corezlcd">
        <div class="zhongXincorezlcd clr">
            <div class="caidan">
                <ul>
                    <li><a href="rechargadmin.aspx" class="a-1">用户提现审核</a></li>
