...
public partial class admin_Chongzhilist : System.Web.UI.Page
{
    ...
    private void BindData()
    {
        ...
        DataSet ds = Task.BLL.tb_MoneyBLL.GetInstance().GetList(pager1.PageSize, CurrentPage, " Type in(1) and Status=1", out allCount);
