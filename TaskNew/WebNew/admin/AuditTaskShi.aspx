<%@ Page Title="代审试用任务管理" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AuditTaskShi.aspx.cs" Inherits="admin_AuditTaskShi" %>
        ...
        <div class="mod_taber mod_taber0">
            <div class="mod_taber_hd">
                <ul class="mod_hlist mod_taber_menu" id="tags_menu">
                    <li><a href="TaskShi.aspx?type=<%=id %>" id="qb" class="on"><span>全部</span></a></li>
                            ...
                            <table class="i_mod_tableA">
                                <tbody>
                                    <tr>
                                        ...
                                        <th scope="col" style="width:240px;">时间/订单号</th>
                                        <th scope="col" style="width:200px; overflow:hidden">用户名/旺旺/QQ</th>
                                        <th scope="col" style="width:100px;">商品截图</th>
                                        <th scope="col" style="width:100px;">下单价格/红包</th>
                                        ...
                                        <ItemTemplate>
                                                ...
                                                <td class="cell2">
                                                    <a href="<%#url %>Details.aspx?id=<%#Eval("id") %>" title="" target="_blank" > 
                                                        <img src="<%#img(Eval("ProductImage").ToString()) %>" onerror="this.src='../images/touxt.jpg';" width="80" height="80"> 
                                                    </a>
                                                </td>
                                                <td class="cell1">
                                                    <p><%#Eval("buyaddtime") %></p>
