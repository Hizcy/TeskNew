        ...
        <table style="width:100%" >
             <tbody style="background-color:#f3f3f3;line-height:37px;">
               <tr> 
                    ...
                    <th style="width:10%;text-align:center">地址</th>
                    <th style="width:30%;text-align:center">内容</th>
             ...
             <asp:Repeater runat="server" ID="rptnotice">
                ...
                <ItemTemplate>
                    <tr style="line-height: 37px;">
                        <td style="width:10%;text-align:center"><%#Eval("IsRed").ToString().Equals("1")?"<font color='#ff0099'; font-size='14px'>"+Eval("ArticleTitle")+"</font>":Eval("ArticleTitle") %></td>
                        <td style="width:10%;text-align:center"><%#Eval("ArticleUrl") %></td>
                        <td style="width:30%;text-align:center"><%#Eval("ArticleContent") %></td>
