<%@ Page Title="商家提现/充值审核" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Merchantadmin.aspx.cs" Inherits="admin_Merchantadmin" %>
        ...
        <div class="zhongXincorezlcd clr">
            <div class="caidan">
                <ul>
                    ...
                    <li><a href="Merchantadmin.aspx" class="a-1">商家提现审核</a></li>
     ...
     <tbody style="background-color:#f3f3f3;line-height:37px;">
       <tr> 
           ...
           <th style="width:10%;text-align:center">QQ</th>       
            ...
            <th style="width:10%;text-align:center">申请金额</th>
            <th style="width:5%;text-align:center">余额</th>
            <th style="width:15%;text-align:center">申请时间</th>
        ...
        <asp:Repeater runat="server" ID="rpttaskadmin">
            <ItemTemplate>
                <tr style="border-bottom:1px dashed  #0f91b8;height:50px;">
                    <td style="width:10%;text-align:center;font-size:15px"><%#Eval("Id") %></td>
                    <td style="width:10%;text-align:center;font-size:15px"><%#Eval("Name") %></td>
                    ...
                    <td style="width:10%;text-align:center;font-size:15px"><%#Eval("DealCode") %></td>
                    <td style="width:10%;text-align:center;font-size:15px"><%#Eval("Money") %></td>
                    <td style="width:5%;text-align:center;font-size:15px"><%#Eval("userMoney") %></td>
