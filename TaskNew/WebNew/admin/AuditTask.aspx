<%@ Page Title="管理员代审核试用任务" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AuditTask.aspx.cs" Inherits="admin_AuditTask" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
                ...
                <div class="mod_taber mod_taber0">
                    <div class="mod_taber_hd">
                        <ul class="mod_hlist mod_taber_menu" id="tags_menu">
                            <li><a href="audittask.aspx?state=1" id="qb" class="on"><span>上架商品</span></a></li>
                             <li><a href="audittask.aspx?state=2" id="qx" class="on"><span>下架商品</span></a></li>
                            ...
                            <div class="mod_taber_page">
                                <div class="mod_taber_page_bd" id="jifen_flow">
                                    <table class="i_mod_tableA">
                                            <tbody>
                                            <tr> 
                                                <th scope="col" style="width:140px">商品图片</th>
                                                <th scope="col" style="width:200px;">创建时间/编号/状态</th>
                                            ...
                                            <tr onmouseover="$(this).addClass('hover');" onmouseout="$(this).removeClass('hover');" class="">
                                                    <td class="cell2">
                                                        <a href="<%=url %>Details.aspx?id=<%#Eval("id") %>" title="搜索关键词进店 店铺浏览5分钟以上其他宝贝 假聊下单" target="_blank">
                                                            <img src="<%#imgUrlReplace(Eval("ProductImage").ToString()+"-jpg279","") %>" onerror="this.src='../images/touxt.jpg';" width="80" height="80">
                                                        </a>
                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                                    <td class="cell1">
                                                        <p><%#Eval("addtime") %></p>
                                                    ...
                                                    <td class="cell1">
                                                        ...
                                                        <p style="margin-top:13px;color:#FC3C75;"><%#Eval("activeaudit").ToString()=="0"?"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;--":Eval("activeend") %></p>
                                                    </td>
    ...
    <script>
        ...
        $(document).ready(function () {
            if (id != 2) {
                $("#qb").css({ "background-color": "yellow", "font-size": "150%" });
                $("#qx").removeClass();
            }
        });
        ...
        if (parseInt(id) == 1) {
            ...
            $("#qx").css({ "background-color": "yellow", "font-size": "150%" });
            $("#qb").removeClass();
        }
        //else if (parseInt(id) == 2) {
        //    $("#wt").addClass("on");
