        ...
        get
        {
            ...
            if (url.ToLower().Equals(path+"home.aspx") || url.ToLower().Equals(path2+"home.aspx"))
            {
                return "<div class=\"box\" id=\"box1\" style=\"width: 100%;height:300%;background: rgba(0,0,0,0.2); position: fixed;  z-index:100000;margin-top:-300px;\">"
                      + " <div class=\"box1\" style=\"position: fixed;left: 40%; top: 25%;\"> <a href=\"helpyq/\"><img src=\"../images2/invitation2.png\" style=\"border-radius:350px\" target=\"_blank\" /></a>"
                      +" <div style=\"float:right;position: absolute;right: 0;top: 0;z-index: 999;\"><a title=\"关闭\" style=\"cursor:pointer;\"><img src=\"../images2/shut.png\"  onclick=\"jQuery('.box').hide()\"/></a></div></div></div>";
            }
            return "";
        }
    }
