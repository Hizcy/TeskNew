...
public partial class admin_Recharglist : System.Web.UI.Page
{
    ...
    private void BindData()
    {
        ...
        DataSet ds = Task.BLL.tb_MoneyBLL.GetInstance().GetList(pager1.PageSize, CurrentPage, " Type in(3) and Status=1", out allCount);
    ...
    public string roleid(string roleid)
    {
        if (int.Parse(roleid) == 0)
            return "用户";
        else if (int.Parse(roleid) == 1)
            return "商家";
        return "";
