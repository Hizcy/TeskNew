...
using System.Data;
public partial class admin_AuditTaskY : BasePage//System.Web.UI.Page
{
    ...
    public string showData(int audit, int id, decimal money, decimal GuaranteePrice, string TaskCode, int ActiveType)
    {
        ...
        {
            return "<p><a href=\"AuditYonglist.aspx?id=" + id + "\" target=\"_blank\" style=\"color:#fe4800;\">资格审核</a></p><p><a href=\"AuditTaskYong.aspx?type=" + id + "\" target=\"_blank\" style=\"color:#3DC054;\">管理订单</a></p>";
        }
        else if (audit == -1)
