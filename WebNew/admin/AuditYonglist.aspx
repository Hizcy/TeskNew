<%@ Page Title="代审佣金任务" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AuditYonglist.aspx.cs" Inherits="admin_AuditYonglist" %>
            ...
            <div class="mod_taber mod_taber0">
                ...
                <div class="mod_taber_hd">
                    <ul class="mod_hlist mod_taber_menu" id="tags_menu">
                        <li><a href="tradeyonglist.aspx?id=<%=taskId %>" id="qb" class="on"><span>全部试用</span></a></li>
                  <%--      <li><a href="tradeyonglist.aspx?id=<%=taskId %>&status=1" id="sy"><span>试用待审核</span></a></li>
                        <li><a href="tradeyonglist.aspx?id=<%=taskId %>&status=2" id="sh"><span>审核通过</span></a></li>
                        <li><a href="tradeyonglist.aspx?id=<%=taskId %>&status=3" id="qx"><span>取消资格</span></a></li>--%>
                    </ul>
                </div>
                        ...
                        <div class="mod_taber_page" >
                            <div class="mod_taber_page_bd" id="jifen_flow">
                                    ...
                                    <table class="i_mod_tableB" style="margin-bottom:0;">
                                        <tbody>
                                        <tr>
                                            <th scope="col" style="width:280px;">用户名/旺旺</th>
                                            <th scope="col" style="width:210px;">下单率/该用户30天内</th>
...
display: inline-flex;"><%#Eval("qq") %></a>
                                           ...
                                           <%-- <td class="cell4">
                                                <p><font id="user_font_2" color="#808080"><%#Eval("IP") %></font></p>
                                                <p style="margin-top:8px;">
                                                    <font color="#09f">
