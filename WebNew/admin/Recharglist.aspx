<%@ Page Title="提现审核记录" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Recharglist.aspx.cs" Inherits="admin_Recharglist" %>
        ...
        <div class="zhongXincorezlcd clr">
            <div class="caidan">
                <ul>
                    ...
                    <li><a href="Recharglist.aspx" class="a-1" style="width:150px">用户/商家提现记录</a></li>
     ...
     <tbody style="background-color:#f3f3f3;line-height:37px;">
       <tr> 
           ...
           <th style="width:10%;text-align:center">角色</th>
            ...
            <th style="width:15%;text-align:center">支付宝（名字）</th>
       ...
       <asp:Repeater runat="server" ID="rpttaskadmin">
            <ItemTemplate>
                <tr style="border-bottom:1px dashed  #0f91b8;height:50px;">
                    ...
                    <td style="width:10%;text-align:center;font-size:15px"><%#roleid(Eval("Roleid").ToString()) %></td>
