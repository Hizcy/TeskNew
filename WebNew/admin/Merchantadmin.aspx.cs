...
public partial class admin_Merchantadmin : System.Web.UI.Page
{
    ...
    private void BindData()
    {
        ...
        DataSet ds = Task.BLL.tb_MoneyBLL.GetInstance().GetList(pager1.PageSize, CurrentPage, " Type in(3) and Status=0 and roleid=1", out allCount);
