<%@ Page Title="佣金任务管理" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AdminYong.aspx.cs" Inherits="admintask_AdminYong" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            ...
            <div class="zhongXincorezlcd clr">
                <div class="caidan">
                    <ul>
                        ...
                        <li><a href="AdminYong.aspx" class="a-1">佣金任务</a></li>
     ...
     <div class="corezlcdtask">
            <div class="zhongXincorezlcd clr">
                <div class="caidan">
                    <ul>
                        <li><a href="AdminYong.aspx" id="qb">全部</a></li>
                        <li><a href="AdminYong.aspx?status=-6" id="fk">待付款</a></li>
                        <li><a href="AdminYong.aspx?status=0" id="sh">待审核</a></li>
                        <li><a href="AdminYong.aspx?status=1" id="tg">审核通过</a></li>
                        <li><a href="AdminYong.aspx?status=-1" id="sb">审核失败</a></li>
                    </ul>
                </div>
            </div> 
        </div>
