...
public partial class admintask_AdminManage : BasePage//System.Web.UI.Page 
{
    ...
    private void BindData()
    {
        ...
        DataSet ds = Task.BLL.tb_TaskBLL.GetInstance().GetTaskauditList(pager1.PageSize, CurrentPage, " 1=1 and ActiveType not in(1,4)"+where, out allCount);
    ...
    protected void btnDaochu_Click(object sender, EventArgs e)
    {
        if(identity != null)
        {
            ...
            DataSet ds = Task.BLL.tb_TaskBLL.GetInstance().GetListtask("ActiveType not in(1,4)"+where);
