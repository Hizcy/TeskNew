...
<body id="top">
    ...
    <a href="<%=path %>Super.aspx"><img src="<%=path %>images2/banner_top.jpg" style="width: 100%;"/></a>
        ...
        <!------------------------------------------导航结束------------------------------------------------>
            ...
            <ul>
                <li>
                    <img src="images2/sjliucheng1.png" style="margin-top: -10px;"/>
                    <img src="images2/sjliucheng2.png" style="margin-top: -6px;" />
                    <img src="images2/sjliucheng3.png" style="margin-top: -6px;" />
                    <img src="images2/sjliucheng4.png" style="margin-top: -6px;" />
                    <img src="images2/sjliucheng5.png" style="margin-top: -6px;" />
                    <img src="images2/sjliucheng6.png" style="margin-top: -6px;" />
                    <img src="images2/sjliucheng7.png" style="margin-top: -6px;" />
                    <img src="images2/sjliucheng8.png" style="margin-top: -6px;" />
                </li>
            </ul>
        </div>
        <!------------------------------------------最底部开始------------------------------------------------>
