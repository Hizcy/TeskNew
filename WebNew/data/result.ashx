...
public class result : IHttpHandler {
    ...
    string appId = "48ba2d5406924297aae8725e67488617";      //对应的应用id，非测试应用需上线使用
    ...
    uint start = 0;
    uint limit = 100;
    string toPhone = "18678867343";            
    string templatedId = "1937";                               //短信模板id，需通过审核
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        try
        {
            ...
            api.setAppId(appId);
            //api.enabeLog(true);
	    string toPhone = context.Request.QueryString["m"];
	    string param = context.Request.QueryString["o"];
        ...
        catch (Exception ex)
        {
            ...
            api.WriteLog(ex.Message + "|" + ex.StackTrace);
