...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <style>
        #div {background: url(images2/banner.jpg) no-repeat;background-size:100%;min-width:1090px;}
        ...
        /*#countainer{margin:auto;width:600px;height:100%;background-color:#cccccc;}*/
    </style>
</head>
<body>
            ...
            <div>
                <div style="height:440px;margin:0 auto;width:999px;z-index: 999;">
                    <div style="padding-top: 300px;">
                        <div style="background:url(images2/navbackgroud.png) no-repeat;height: 52px;line-height: 50px;">
                ...
                <div style="/*height:876px;*/margin:0 auto;width:999px;">
                    ...
                    <div style="/*background-color: #fff;*/padding: 40px 0;margin-top: -40px; width: 1000px;">
                        ...
                        <div id="biankuang2" style="background:white;padding: 10px 0;">
                             <div style="background:url(images2/navbackgroud.png) no-repeat;/*height: 68px;*/line-height: 50px;margin-top: -10px;text-align:center;margin-left: -2px;">
