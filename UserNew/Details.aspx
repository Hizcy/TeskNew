       ...
       <!-- <div class="flow">
        ...
        <div class="tao oz ">
            	<div class="left oz">
            		...
            		<div class="contxb_left" style="width:293px;">
            			<div class="pr">
                            <a target="_blank" >
            					<img src="<%=ProductImage %>" style="width:292px;height:438px;" onerror="this.src='<%=path %>images/quesheng.jpg'"/>
            				</a>
            			</div>
            		...
            		<div class="cont_right">
            			...
            			<div class="ask">
                            ...
                            <%}else{ %>
                                <div class="apply oz">
                                    <%if (allow ==1){ %>
                                   <a class="cf tc  hrefs" style="background-color: #ff6094;width: 155px;height: 45px;border-radius: 2px;line-height: 40px;color: #fff;border:0;cursor:pointer;font-size:22px;">立即申请</a>
                                    ...
                                    <%} %>
                                    <a class="cf tc  hrefs" style="background-color: rgb(153,153,153);width: 155px;height: 45px;border-radius: 2px;line-height: 40px;color: #fff;border:0;cursor:pointer;font-size:22px;    ">金币兑换</a>
							    </div>
			    		...
			    		<div class="infoCont">
			    				...
			    				<ul>
                                    <li>
                                        ...
                                        <a id="shiyongjilu" dataid="dy4" class="">审核通过</a>
                                           <a id="shiyongdetail" dataid="dy6" class="">商品详情</a>
			    			...
			    			<div class="border tabCont">
                               ...
                               <div id="dy4" class="cont" style="margin:30px;margin-left: 50px;display:none" >
                                  ...
                                  <!---------试用详情------------>
                                 <div id="dy6" class="cont" style="margin:30px;margin-left: 50px;display:none" >
								    <table style="text-align:center;width:100%;margin-top: -40px;border-spacing: 10px;">
                                        <tbody>
                                            <%=imgurls %>
                                        </tbody>
    ...
    <%-- 遮罩层  选择淘宝会员 --%>
        <div class="box" id="box1" style="display:none;width: 100%;height:300%;background: rgba(0,0,0,0.2); position: fixed;  z-index:100000;margin-top:-300px;">"
            <div class="box1" style="position: fixed;left: 33%; top: 25%;background-color:#ff6094"> 
                    ...
                    <div style="background-color:#ff6094;"> 
