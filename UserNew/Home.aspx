...
<!------------------------------------------大图开始------------------------------------------------>
        ...
        <div class="banner-con">
            <div class="banner-left">
                <div class="shop_type_exchange">
                    <h3>精品兑换</h3>
                    <a href="#" target="_blank" style="color:#6C6C65;color:#6e6e6e">高价值</a>
                    <a href="#" target="_blank" style="color: #FF0077;font-weight:600">高人气</a>
                    <a href="#" target="_blank" style="margin:0;color:#6C6C65">新&nbsp;&nbsp;品</a>
                </div>
                <div>
                ...
                <div id="slideBox" class="slideBox" style="padding:10px;">
                    ...
                    <div class="bd">
                        <ul style="position: relative; width: 632px; height: 325px;">
                            <li style="position: absolute; width: 632px; left: 0px; top: 0px; display: list-item;"><a href="#" target="_blank"><img src="images/yaoqinghaoyou.png" alt="商家入驻"/></a></li>
							<li style="position: absolute; width: 632px; left: 0px; top: 0px; display: none;"><a href="#" target="_blank"><img src="images/yaoqinghaoyou.png" alt="邀请好友"/></a></li>
							<li style="position: absolute; width: 632px; left: 0px; top: 0px; display: none;"><a href="#" target="_blank"><img src="images/shike.png" alt="试客"/></a></li>
						</ul>
                    </div>
                </div>
                       ...
                       { %>
                        <div class="userinfo_con_login" >
                            ...
                            <div style="margin-top:25px;margin-right:-10px">
                            	<a href="login.aspx" class="login" style="border-style: solid;border-width: 2px;border-color:#FF0077;border-radius: 6px;padding: 7px 17px;color:#FF0077">登录</a>
                        ...
                        <div class="notice-list">
                            <ul style="display: block;">
                                <asp:Repeater runat="server" ID="rptnoticet">
                                    <ItemTemplate>
                                         <li><a href="help.aspx?aid=<%#Eval("ArticleId") %>" target="_blank" style="color:#6e6e6e;"><%#Eval("ArticleTitle").ToString().Length>15?Eval("ArticleTitle").ToString().Substring(0,15)+"……":Eval("ArticleTitle").ToString() %><span style="float:right;margin-right: 5px;">详情</span></a></li>
                                    </ItemTemplate>
                                </asp:Repeater>
                             </ul>
    ...
    <div id="Div1" class="layout_1090" >
        <img src="images/liucheng.png" style="width:1200px;margin-top: 20px;" />
    </div>
    
    <div id="Div3" class="layout_1090" >
        <div style="float:left; margin-top: 20px;">
            <a href="#"><img src="images/imgnew01.png" /></a></div>
        <div style="float:left; margin-top: 20px;">
                     ...
                     <ItemTemplate>
                         <div class="newgoods-wraps one-tmall">
                            ...
                            <a href="Details.aspx?id=<%#Eval("id") %>" class="piwik_link one-brand-hd" target="_blank">
                                <img style="width: 279px; height: 300px; display: inline-block; background-position: 50% 50%; background-repeat: no-repeat;" class="lazy" alt="女装夏装2016新款潮30-40岁雪纺衫短袖胖mm中长款宽松上衣衬衫" width="640" height="480" data-original="<%#Image(Eval("ProductImage").ToString(),"s") %>">
        			        </a>
        			        <a href="Details.aspx?id=1424" target="_blank" class="piwik_link ect zuixingoods-tit dsb"><%#Eval("ActiveName").ToString().Replace("20%","")%></a>
     ...
     <div class="layout_1090xb" style="width:1200px;">
         <div style="border-bottom:2px solid #FF0077;border-bottom: 2px solid #FF0077;padding: 30px 10px;">
             ...
             <div style="float:right">
                 ...
                 <div style="float:left;font-weight: 600;font-size: 16px;">
                     <a href="../quan/YouHuiQuan.aspx"><i style="padding: 0 10px;color: #000;font-weight: 600;">查看更多</i></a>
                 </div>
             </div>
         </div>
                        ...
                        <div class="conts">
                            ...
                            <div class="quanbuy">
                                ...
                                <div >
                                    ...
                                    <a class="quan_bt1" href="http://s.click.taobao.com/7USSiWx" target="_blank" rel="nofollow" title="平台金币兑换">金币兑换</a>
    ...
    <div class="layout_1090xb" style="width:1200px;">
        <div style="border-bottom:2px solid #FF0077;border-bottom: 2px solid #FF0077;padding: 30px 10px;">
             ...
             <div style="float:right">
                 ...
                 <div style="float:left;font-weight: 600;font-size: 16px;">
                     <i style="padding: 0 10px;color: #000;font-weight: 600;">查看更多</i>
                 </div>
             </div>
         </div>
        ...
        <ul class="grid effect-1" id="grid">
            <li>
                <div class="lidiv">
                    <a href="#" target="_blank">
                        <img src="images/02.jpg" style="height:373px":/>
                    </a>
                    <div class="list_xiu">
                        <div class="list_xiu_img">
                            <img src="images/001.png"  width="48" height="48"/>
                        </div>
                        <div class="list_xiu_right">
                            <h5>羞嗒嗒</h5>
                            <p>
                                <a href="#" target="_blank">好嗨森啊，感谢折品购，第一次中大奖，哈哈...</a>
                            </p>
                        </div>
                    </div>
                </div>
                <div class="lidiv">
                    <a href="#" target="_blank">
                        <img src="images/12.jpg" style="height:373px":/>
                    </a>
                    <div class="list_xiu">
                        <div class="list_xiu_img">
                            <img src="images/002.png" width="48" height="48"/>
                        </div>
                        <div class="list_xiu_right">
                            <h5>旧街凉风</h5>
                            <p>
                                <a href="#" target="_blank">哈哈，裙子真的是超级漂亮啊，一直想买一个这样的。~</a>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="lidiv">
                <a href="#" target="_blank">
                    <img src="images/14.jpg"  style="height:373px":/>
                </a>
                <div class="list_xiu">
                    <div class="list_xiu_img">
                        <img src="images/004.jpg" width="48" height="48"/>
                    </div>
                    <div class="list_xiu_right">
                        <h5>亡梦爱人</h5>
                        <p>
                            <a href="#" target="_blank"> 自从注册这个账号后，在这里得到了好多宝贝哦~</a>
                        </p>
                    </div>
                </div>
            </div>
                <div class="lidiv">
                    <a href="#" target="_blank">
                        <img src="images/09.jpg" style="height:373px":/>
                    </a>
                    <div class="list_xiu">
                        <div class="list_xiu_img">
                            <img src="images/009.png" width="48" height="48"/>
                        </div>
                        <div class="list_xiu_right">
                            <h5>耳边的清风</h5>
                            <p>
                                <a href="#" target="_blank"> 面膜真的好用呢，在折品购上居然有这么好用的东西~</a>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="lidiv">
                <a href="#" target="_blank">
                    <img src="images/03.jpg"  style="height:373px":/>
                </a>
                <div class="list_xiu">
                    <div class="list_xiu_img">
                        <img src="images/006.png" width="48" height="48"/>
                    </div>
                    <div class="list_xiu_right">
                        <h5>华灯初上</h5>
                        <p>
                            <a href="#" target="_blank">加入折品购之后每天都是开开心心哒！...</a>
                        </p>
                    </div>
                </div>
            </div>
                <div class="lidiv">
                    <a href="#" target="_blank">
                        <img src="images/10.jpg" style="height:373px":/>
                    </a>
                    <div class="list_xiu">
                        <div class="list_xiu_img">
                            <img src="images/007.png" width="48" height="48"/>
                        </div>
                        <div class="list_xiu_right">
                            <h5>无聊也不无聊</h5>
                            <p>
                                <a href="#" target="_blank"> 收到好久了，一直不舍得拿出来哈料子薄厚适度，微微有些弹...</a>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="lidiv">
                <a href="#" target="_blank">
                    <img src="images/08.jpg" height="373.33333333333"/>
                </a>
                <div class="list_xiu">
                    <div class="list_xiu_img">
                        <img src="images/003.jpg" width="48" height="48"/>
                    </div>
                    <div class="list_xiu_right">
                        <h5>一只失宠猫</h5>
                        <p>
                            <a href="#" target="_blank">玩折品购的时间也挺长了，居然被大奖砸中....</a>
                        </p>
                    </div>
                </div>
            </div>
                <div class="lidiv">
                    <a href="#" target="_blank">
                        <img src="images/06.jpg" height="373.33333333333"/>
                    </a>
                    <div class="list_xiu">
                        <div class="list_xiu_img">
                            <img src="images/008.jpg" width="48" height="48"/>
                        </div>
                        <div class="list_xiu_right">
                            <h5>再回首</h5>
                            <p>
                                <a href="#" target="_blank">折品购真是一个好地方，使我的生活充满了乐趣呢！</a>
                            </p>
                        </div>
                    </div>
                </div>
...
<%--     <div id="Div2" class="layout_1090" style=" margin-right: 155px;">
    ...
    <div style="width: 100%;margin: 0 auto;" >
        ...
        <div style="width:100%;margin-top:40px;height:6px;line-height:33px;border-top:1px solid #e4e4e4;font-size:34px;padding:25px 0;margin:5px 0;margin-left:10px" >
            <img src="images/1111.png" style="margin-left:400px;" />
                            ...
                            <div class="proclass_left">
                                ...
                                <ul>
                                    ...
                                    <li><a href="javascript:;">你们平台的优势是什么？</a>
                                	    <p style="display: none;"><img src="images/tan_pro_icon.jpg">我们是全网唯一适合高价值推广的试用平台，试客申请或下单领取都要强制进店完成任务并上传提交才可进行下一步，在折品购发布任务，只需每次拿出宝贝库存的10-20件，通过免费试用的模式，折品购帮助你优化新品权重，轻松推广无需额外再出推广费用，节省2/3的推广费用一举两得！</p>
                                    </li>
                                    <li><a href="javascript:;">你们和淘宝试用/试客联盟有什么区别？</a>
                                	    <p style="display: none;"><img src="images/tan_pro_icon.jpg">我们的试客是连续3日进店完成收藏、加购等任务的，100%可提升店铺所需权重，试客联盟等传统试用模式虽然申请人数多，但是没有几个真正进店的，更别说完成众多任务了，说白了，只能刷刷销量而已，现在淘宝玩法变了，只刷销量对提升搜索排名影响没有那么大了，我们应该注重店铺的全面优化，而我们就是为店铺全面优化而诞生的试用平台</p>
                                    </li>
                                    ...
                                    <li><a href="javascript:;">高单价的商品适合吗？</a>
                                	    <p style="display: none;"><img src="images/tan_pro_icon.jpg">我们现在试用平台针对高单价也单独推出一个模式，让高单价商品的展示天数长久些，能给商家带来的一些权重比较多，假如一个商品有几百个人申请，就会有几百人的搜索点击、收藏加购、重复访问等权重，你自己投放直通车能给你带来的能有多少搜索点击、收藏加购呢</p>
                                    </li>
                                </ul>
                                ...
                                <ul>
                            	    <li><a href="javascript:;">发布任务是否需要支付佣金？以及其他费用？</a>
                                	    <p style="display: none;"><img src="images/tan_pro_icon.jpg">"商家发布任务需要支付商品等额的押金、担保金、返款手续费。例如：如果您提供的商品是100元，就需要支付100元的商品押金+5%的担保金（担保金活动后会退还）+1%的代返款手续费"</p>
                                    </li>
                                    <li><a href="javascript:;">入驻平台商家是否需要交纳会员费？多少钱？</a>
                                	    <p style="display: none;"><img src="images/tan_pro_icon.jpg">"我们是会员制网站，商家VIP会员费是3288元/年，一天仅需8.3元，全年发布试用不限次数。"</p>
                                    </li>
                                    <li><a href="javascript:;">可以免费试一下嘛？</a>
                                	    <p style="display: none;"><img src="images/tan_pro_icon.jpg">亲，咱们现在网站做活动，注册立送300元VIP会员服务1个月，您可以直接注册普通商家绑定店铺就可以发布任务了</p>
                                    </li>
                                    <li><a href="javascript:;">会员费用可不可以便宜点？</a>
                                	    <p style="display: none;"><img src="images/tan_pro_icon.jpg">我们会员费是系统默认的价格，多一分少一分都是加入不了的呢，而且您首次加入是什么价格，来年续费就还是什么价格，绝对超值的哦</p>
                                    </li>
                                ...
                                <ul>
                            	    <li><a href="javascript:;">你们的试客账号安不安全？</a>
                                	    <p style="display: none;"><img src="images/tan_pro_icon.jpg">亲，我们95%的会员都是付费会员，需绑定买号信息并通过平台审核后，方可申请绑定买号的要求：<br>①淘宝买号2心信誉以上<br>②注册时长1个月以上<br>③通过支付宝实名认证<br>④1人1号，需添加身份证信息的验证<br>杜绝一切小号或危险账号申请商家的试用任务，买号安全性可以得到保障<br>同时，咱们又是来自全国各地真人的搜索点击进店、收藏、加购等，只会优化贵店的权重，提升排名，这么给力的平台，您怎么还会担心降权的问题呢？</p>
                                    </li>
                            ...
                            <div class="proclass_right">
                                ...
                                <ul>
                                    ...
                                    <li><a href="javascript:;" style="color:red;">会员费用太贵了，我没那么多钱怎么办？</a>
                                	    <p style="display: none;"><img src="images/tan_pro_icon.jpg">3288元/年，平均一天才9块钱，你吃个早餐的钱都不止呢？可以为商品奠定权重基础，日积月累生意越做越好做；总比那些花费几千几万块报上官方活动要靠谱得多呢，如果你宁愿选择后者，生意只会越来做难做哦</p>
                                    </li>
                                    ...
                                    <li><a href="javascript:;">一个账号可以绑定几个店铺？</a>
                                	    <p style="display: none;"><img src="images/tan_pro_icon.jpg">每个账号可绑定淘宝、天猫、京东3大平台6个店铺，每个平台的第1个店铺绑定免费，第二个店铺需支付888元</p>
                                    </li>
                                    ...
                                    <li><a href="javascript:;">我想发布1000件，你们平台能消化的了吗？</a>
                                	    <p style="display: none;"><img src="images/tan_pro_icon.jpg">咱们完全没必要这么做呢，我不说您也知道现在淘宝玩法变了，只注重刷销量和爆款，对排名的提升影响不大，要全面提升店铺权重，才是提升排名的关键，而我们可以保证试客在申请或下单领取需要连续多日进店完成任务，从而有效提升店铺所需权重，咱们只需提供几十件商品，效果比您提供1000件商品的效果还好，我也是为您省钱考虑的哈，咱们都是有什么说什么的呢！</p>
                                    </li>
                ...
                <div class="novice_proclass">
                	<div style="overflow:hidden;">
                        <div class="proclass_left">
                            <h4>发布试用类问题：</h4>
                            <ul>
                                <li><a href="#" target="_blank">如何发布试用任务呢？</a>
                                	
                                </li>
                                <li><a href="#" target="_blank">在平台发布任务流程是什么？</a>
                                	
                                </li>
                                <li><a href="javascript:;">发布任务需要哪些费用？</a>
                                	<p style="display: none;"><img src="images/tan_pro_icon.jpg">商品押金=发布件数*单价，因中奖试客回去店铺下单领取，此时资金已经回笼到贵店支付宝中；除商品押金外，还需预付5%的退款保证金，这个是为了商家可及时给试客确认返款，这个钱最后会结算给您）因审核试客和给试客返款均是平台代为处理的，所以收取精准投放的20金币/次及1%的退款手续费</p>
                                </li>
                                <li><a href="javascript:;">不同任务类型有什么区别？</a>
                                	<p style="display: none;"><img src="images/tan_pro_icon.jpg">目前开发的任务类型为常规试用任务类型和高价值商品任务类型以及提升商品销量/转化权重试用，常规试用任务试客可分3天重复进店完成收藏 加购等任务；高价值商品适用于价值高于200元以上的商品，选择此服务可延长抽奖周期至5天或8天，可吸引更多试客关注申请；提升商品权重试用，至少需要投放30份试用，通过最安全的试用流程，提高"成长期"商品的订单转化率和销量权重，帮助宝贝脱颖而出</p>
                                </li>
                            ...
                            <h4>绑定店铺类问题：</h4>
                            <ul>
                                <li><a href="#" target="_blank">如何绑定店铺？</a>
                                	
                                </li>
                                <li><a href="javascript:;">一个账号可以绑定几个店铺？</a>
                                	<p style="display: none;"><img src="images/tan_pro_icon.jpg">每个账号可绑定淘宝、天猫、京东3大平台，每个平台的第1个店铺为免费绑定，第二个店铺需支付888元，每个账号最多绑定6个店铺</p>
                                </li>
                                ...
                                <li><a href="javascript:;">绑定的店铺可以更换吗？</a>
                                	<p style="display: none;"><img src="images/tan_pro_icon.jpg">绑定的店铺未发过任务，可有一次解绑店铺的机会；已发过任务的绑定店铺，均不可以解绑</p>
                                </li>
                            </ul>
                        </div>
                        <div class="proclass_right">
                            ...
                            <ul>
                            	<li><a href="javascript:;">发布的试用什么时候可以审核？</a>
                                	<p style="display: none;"><img src="images/tan_pro_icon.jpg">当日18点前发布的试用任务，将在当日审核后上线；当日18点后发布的试用任务，将在当日审核后于次日10点统一上线；如您有特殊需求可联系在线QQ:4000082618沟通解决</p>
                                </li>
                                <li><a href="javascript:;">审核不通过的怎么办？</a>
                                	<p style="display: none;"><img src="images/tan_pro_icon.jpg">审核不通过的任务，客服会第一时间通过QQ或电话告知商家，请各位商家配合修改后告知客服，客服会重新给予审核后上线</p>
                                </li>
                                <li><a href="#" target="_blank">如何快速通过审核？</a>
                                </li>
                            </ul>
                            <h4>发货类问题：</h4>
                            <ul style="border:none;">
                                <li><a href="javascript:;">试客拍错规格怎么办？</a>
                                	<p style="display: none;"><img src="images/tan_pro_icon.jpg">您的任务有指定是试客拍下规格试客排错时，请先不要发货，请联系在线客服QQ：4000082618联系试客处理；任务未设置制定规格，则默认试客可以拍下任意规格商品</p>
                                </li>
                            ...
                            <ul style="border:none;">
                                ...
                                <li><a href="javascript:;">任务结束了，冻结的钱什么时候发给我？</a>
                                	<p style="display: none;"><img src="images/tan_pro_icon.jpg">目前系统自动结算功能还未上线，如您急需结算冻结押金，请联系在线客服QQ：4000082618处理</p>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="novice_proclass">
                	<div style="overflow:hidden;">
                        <div class="proclass_left">
                            <h4>任务申请类：</h4>
                            <ul>
                                <li><a href="javascript:;">1.未按照任务要求进店/浏览</a>
                            ...
                            <h4>评价售后类：</h4>
                            <ul style="border:none;">
                                <li><a href="javascript:;">1.未按照任务要求评价</a>
                                ...
                                <li><a href="javascript:;">2.申请售后/退款/投诉</a>
...
此外，还有助于提升商品的自然搜索、人气搜索排名，获得更多优质的自然流量，提高转化率，所以商家才会免费赠送商品给试客试用。"</p>
                                ...
                                <li><a href="javascript:;">申请一定可以中奖吗？</a>
                                	<p><img src="images/tan_pro_icon.jpg">"首次申请必中100元以内的商品，虽然申请不能保证一定中奖，但是基本每个任务都有3次中奖机会，中奖概率还是比较高的呢，如果您心仪的商品没有中奖的话，
还可以申请其他商品，平台有折品购满目的商品供您选择，申请越多中奖概率越高哦~"</p>
                                </li>
                        ...
                        <div class="proclass_right">
                            ...
                            <ul>
                                <li><a href="javascript:;">如何申请免费试用？</a>
                                	<p><img src="images/tan_pro_icon.jpg">试客流程：注册会员 → 申请试用 → 获得资格并下单领取 → 收货好评 → 返还本金，详细教程查看：<a href="http://www.zhongguohuo.com/test/index_m" target="_blank">点击查看</a></p>
                                </li>
                        ...
                        <div class="proclass_left">
                            ...
                            <ul>
                                <li><a href="javascript:;">中奖之后需要多长时间领取？</a>
                                	<p style="display: none;"><img src="images/tan_pro_icon.jpg">通过试用审核商品请在48小时之内下单领取，超时系统将取消中奖资格，多次放弃领取会降低中奖率</p>
                                </li>
                                ...
                                <li><a href="javascript:;">下单金额和任务金额不一致怎么办？</a>
                                	<p style="display: none;"><img src="images/tan_pro_icon.jpg">任务均有客服确认审核以后才能上线，部分商家会设定满立减或下单立减等活动，请先在淘宝/京东等第三方平台提交订单查看价格情况，若价格没有变更，再联系在线客服协助处理。</p>
                                </li>
                        ...
                        <div class="proclass_right">
                            ...
                            <ul style="border:none;">
                                ...
                                <li><a href="javascript:;">超48小时平台未发货/返款订单如何处理？</a>
                                	<p style="display: none;"><img src="images/tan_pro_icon.jpg">超48小时平台未发货订单，系统会自动变更为已发货；未返款订单统一于下帖跟帖回复，客服每日跟进处理：<a href="#" target="_blank">点击进入</a></p>
                                </li>
                                <li><a href="javascript:;">如何提现垫付本金？退到哪里？</a>
                                	<p style="display: none;"><img src="images/tan_pro_icon.jpg">垫付本金是统一提现到个人银行卡的~申请提现后，财务在1-2个工作日审核退款，周末节假日顺延。</p>
                                </li>
                                <li><a href="javascript:;" style="color:red;">提现有什么限制吗？什么时候到账？</a>
                                	<p style="color: red; display: none;"><img src="images/tan_pro_icon.jpg">为了保障试客和商家交易金额的准确性，平台将预留5天的资金核查周期，返款到账户的资金将被冻结5天，5天后本金将自动解冻，之后方可自行提现；<br>累计金额满200元即可申请提现，每个月有3次提现机会，提现收取5%服务费。</p>
                                </li>
