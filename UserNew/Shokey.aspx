...
<body id="top">
    ...
    <a href="<%=path %>Super.aspx"><img src="<%=path %>images/banner_top.jpg" style="width: 100%;"/></a>
        ...
        <%--试客使用流程--%>
            ...
            <ul>
                <li>
                    <img src="images/skliucheng1.png" style="margin-top: -10px;"/>
                    <img src="images/skliucheng2.png" style="margin-top: -6px;" />
                    <img src="images/skliucheng3.png" style="margin-top: -6px;" />
                    <img src="images/skliucheng4.png" style="margin-top: -6px;" />
                    <img src="images/skliucheng5.png" style="margin-top: -6px;" />
                    <img src="images/skliucheng6.png" style="margin-top: -6px;" />
                    <img src="images/skliucheng7.png" style="margin-top: -6px;" />
                    <img src="images/skliucheng8.png" style="margin-top: -6px;" />
                </li>
            </ul>
        </div>
        <!------------------------------------------最底部开始------------------------------------------------>
