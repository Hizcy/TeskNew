                ...
                <div class="i_mod_boxB_bd">
                    <div class="clearfix">
                        ...
                        <div class="col_l col_B">
                            <div class="r_n_em r1">
                                <span class="c_em1 n_em" style="float:left;padding:-2px 10px;margin-left: -10px;"><%=money %></span>元
                                <em class="c_red">
                                <a href="Withdraw.aspx" class="com_btn min_gray_s" style="display:inline-block;width:68px;line-height: 28px;height:28px;">提现</a>
                                </em>
                            </div>
                            <div class="r4">亲~！剩余的可用余额是随时可以提现哦!</div>
                        </div>
                         <div class="col_l col_A" style="margin-top:62px; margin-left: -477px;">
                            <h3>可用金币</h3>
                        </div>
                        <div class="r_n_em r1">
                            <span style="float:left;padding:10px 10px;margin-top: 62px;margin-left: -430px;"><i class="c_em1 n_em"><%=point %></i>&nbsp;金币</span>
                        </div> 
                    </div>
                    <%=stateExam %>
                            ...
                            <asp:Repeater runat="server" ID="rptdetails">
                                <ItemTemplate>
                                    <li>
                                       ...
                                       <a href="Details.aspx?id=<%#Eval("Id") %>" target="_blank" > <p class="shenqing">申请试用</p></a>
					                </li>
                                </ItemTemplate>
                            </asp:Repeater>
				        </ul>
                    ...
                    <div class="mi_bbs">
                        <ul id="Ul1">
                            <asp:Repeater runat="server" ID="rptnotice">
                                <ItemTemplate>
                                    <li><a href="notice.aspx?aid=<%#Eval("ArticleId") %>" target="_blank">● <%#Eval("ArticleTitle") %></a></li>
