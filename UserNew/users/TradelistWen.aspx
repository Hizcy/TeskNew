                            ...
                            <div class="mod_taber_page_bd" id="jifen_flow">
				                <table class="i_mod_tableA">
                                        <tbody>
                                            ...
                                            <tr >
                                                <td class="cell2">
                                                    <a href="<%=path %>QaDetails.aspx?id=<%#Eval("TaskId") %>&_g=<%=gu %>" title="<%#Eval("activequestion") %>" target="_blank"> <img src="<%#imgUrlReplace(Eval("ProductImage").ToString(),"s") %>" onerror="this.src='../images/touxt.jpg';" width="50" height="50"></a>
                                                </td>
	                                            <td class="cell1">
