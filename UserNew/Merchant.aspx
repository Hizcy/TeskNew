...
<body id="top">
    ...
    <a href="<%=path %>Super.aspx"><img src="<%=path %>images/banner_top.jpg" style="width: 100%;"/></a>
        ...
        <!------------------------------------------导航结束------------------------------------------------>
            ...
            <ul>
                <li>
                    <img src="images/sjliucheng1.png" style="margin-top: -10px;"/>
                    <img src="images/sjliucheng2.png" style="margin-top: -6px;" />
                    <img src="images/sjliucheng3.png" style="margin-top: -6px;" />
                    <img src="images/sjliucheng4.png" style="margin-top: -6px;" />
                    <img src="images/sjliucheng5.png" style="margin-top: -6px;" />
                    <img src="images/sjliucheng6.png" style="margin-top: -6px;" />
                    <img src="images/sjliucheng7.png" style="margin-top: -6px;" />
                    <img src="images/sjliucheng8.png" style="margin-top: -6px;" />
                </li>
            </ul>
        </div>
        <!------------------------------------------最底部开始------------------------------------------------>
