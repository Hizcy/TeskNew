...
$.fn.Validform = function(c){
    ...
    ,b = {
        ...
        reg : {
            ...
            alipay : [[3,/^(0{0,1}(13[0-9]|14[6|7]|15[0-3]|15[5-9]|18[0-9]|177)[0-9]{8}||([a-zA-Z0-9]+[_|\_|\-|\.]?)*@([a-zA-Z0-9]+[_|\_|\.]?)*[a-zA-Z0-9]+\.[a-zA-Z]{2,3})$/]],
            tenpay   : [[3,/^(0{0,1}(13[0-9]|14[6|7]|15[0-3]|15[5-9]|18[0-9]|177)[0-9]{8}||([a-zA-Z0-9]+[_|\_|\-|\.]?)*@([a-zA-Z0-9]+[_|\_|\.]?)*[a-zA-Z0-9]+\.[a-zA-Z]{2,3}||[1-9]{1}[0-9]{4,10})$/]],
