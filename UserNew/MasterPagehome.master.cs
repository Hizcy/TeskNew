...
public partial class MasterPagehome :System.Web.UI.MasterPage
{
    ...
    protected string GetFirst()
    {
        ...
        menu = "<ul><li><a href=\"" + path + "home.aspx\"  class=\"{0}\" rel=\"nofollow\">{8}</a></li>"
                    ...
                    + "<li><a href=\"" + path + "quan/YouHuiQuan.aspx\" class=\"css {1}\">优惠券<span class=\"ico_mallx ico_mall_menuhot\"></span></a></li>"
            //+ "<li><a href=\"" + path + "commlist.aspx\"  class=\"css {3}\">佣金任务</a></li>"
                    + "<li><a href=\"" + path + "qaTaskList.aspx\"  class=\"css {4}\">流量任务<span class=\"ico_mall ico_mall_menuhot\"></span></a></li>"
                    + "<li><a href=\"" + path + "Yaoqing.aspx\" target=\"_blank\" class=\"css {5}\" rel=\"nofollow\" style=\"color:#FF0099\">邀请有奖</a></li>"
            ...
            // + "<li style=\"float: right;\"><a href=\"" + path + "sellerIn.html\" target=\"_blank\" class=\"css {7}\" rel=\"nofollow\" >商家入驻</a></li></ul>";
                   + "<li style=\"float: right;\"><a href=\"" + path + "sellerIn.html\" target=\"_blank\" class=\"css {7}\" rel=\"nofollow\" style=\"color:#FF0099;font-weight:600;font-size:16px;margin-right:-21px;\">商家必读</a></li>"
                    + "<li style=\"float: right;\"><a href=\"" + path + "sellerIn.html\" target=\"_blank\" class=\"css {7}\" rel=\"nofollow\" style=\"color:#FF0099;font-weight:600;font-size:16px\">试客必读</a></li>"
                   + "<li style=\"float: right;\"><a href=\"http://www.91zhepingou.com/bbs/index.aspx\" target=\"_blank\" class=\"css {7}\" rel=\"nofollow\" style=\"color:#FF0099;font-weight:600;font-size:16px\">论坛</a></li></ul>";
        ...
        //{
        //    return string.Format(menu, "css", "", "", "nextCss", "", "", "", "", "首页 HOME");
        //}
